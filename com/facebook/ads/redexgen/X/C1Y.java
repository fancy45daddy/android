...
public final class C1Y extends C3G {
     ...
     */
    public static Point A02(C0305Cm c0305Cm, Format format) throws C0314Cv {
        int i = 0;
        ...
        while (i < length) {
            ...
            if (C0430Hl.A02 >= 21) {
                ...
                Point A0E = c0305Cm.A0E(i6, i4);
                if (c0305Cm.A0H(A0E.x, A0E.y, format.A01)) {
                    return A0E;
                }
            } else {
                int A04 = C0430Hl.A04(i4, 16) * 16;
                int A042 = C0430Hl.A04(i5, 16) * 16;
                if (A04 * A042 <= C0316Cx.A00()) {
                    int i7 = z ? A042 : A04;
                    if (!z) {
                        A04 = A042;
                    }
    ...
    public final int A1B(InterfaceC0311Cs interfaceC0311Cs, B8<C0778Vh> b8, Format format) throws C0314Cv {
        ...
        if (HO.A0B(str)) {
            ...
            C0305Cm A6L = interfaceC0311Cs.A6L(str, z);
            String[] strArr = A0e;
            if (strArr[2].charAt(13) != strArr[0].charAt(13)) {
                ...
                strArr2[1] = "UL9g0IqkI";
                if (A6L == null) {
                    return (!z || interfaceC0311Cs.A6L(str, false) == null) ? 1 : 2;
                } else if (AbstractC0310Cr.A0x(b8, drmInitData)) {
                    ...
                    if (A0I && format.A0F > 0 && format.A08 > 0) {
                        if (C0430Hl.A02 >= 21) {
                            ...
                            A0I = A6L.A0H(i2, i3, format.A01);
                        } else {
                            A0I = format.A0F * format.A08 <= C0316Cx.A00();
                            if (!A0I) {
                                String str2 = A05(298, 29, 54) + format.A0F + A05(1379, 1, 65) + format.A08 + A05(856, 3, 97) + C0430Hl.A04 + A05(855, 1, 27);
                            }
                        }
                    }
    ...
    public C1Y(Context context, InterfaceC0311Cs interfaceC0311Cs, long j, @Nullable B8<C0778Vh> b8, boolean z, @Nullable Handler handler, @Nullable I9 i9, int i) {
        super(2, interfaceC0311Cs, b8, z);
        this.A0U = j;
        this.A0T = i;
        this.A0V = context.getApplicationContext();
        this.A0W = new C0442Hz(this.A0V);
        this.A0X = new I8(handler, i9);
        this.A0Y = A0M();
    ...
    public static int A00(C0305Cm c0305Cm, Format format) {
        if (format.A09 != -1) {
            int i = 0;
        ...
        return A01(c0305Cm, format.A0O, format.A0F, format.A08);
    }
    ...
    */
    public static int A01(com.facebook.ads.redexgen.X.C0305Cm r11, java.lang.String r12, int r13, int r14) {
        /*
    ...
    private final MediaFormat A03(Format format, C0438Hv c0438Hv, boolean z, int i) {
        MediaFormat mediaFormat = new MediaFormat();
        mediaFormat.setString(A05(1094, 4, 60), format.A0O);
        mediaFormat.setInteger(A05(1359, 5, j.AppCompatTheme_textAppearanceSearchResultTitle), format.A0F);
        mediaFormat.setInteger(A05(971, 6, 97), format.A08);
        C0317Cy.A06(mediaFormat, format.A0P);
        C0317Cy.A03(mediaFormat, A05(954, 10, j.AppCompatTheme_windowNoTitle), format.A01);
        C0317Cy.A04(mediaFormat, A05(1180, 16, 77), format.A0B);
        C0317Cy.A02(mediaFormat, format.A0J);
        mediaFormat.setInteger(A05(1079, 9, 16), c0438Hv.A02);
        mediaFormat.setInteger(A05(1055, 10, 79), c0438Hv.A00);
        C0317Cy.A04(mediaFormat, A05(1065, 14, 77), c0438Hv.A01);
        if (C0430Hl.A02 >= 23) {
    ...
    private final C0438Hv A04(C0305Cm c0305Cm, Format format, Format[] formatArr) throws C0314Cv {
        int i = format.A0F;
        int i2 = format.A08;
        int A00 = A00(c0305Cm, format);
        int maxHeight = formatArr.length;
        if (maxHeight == 1) {
            return new C0438Hv(i, i2, A00);
        }
        boolean z = false;
        for (Format format2 : formatArr) {
            if (A0V(c0305Cm.A03, format, format2)) {
                z |= format2.A0F == -1 || format2.A08 == -1;
                i = Math.max(i, format2.A0F);
                i2 = Math.max(i2, format2.A08);
                A00 = Math.max(A00, A00(c0305Cm, format2));
            }
        }
        if (z) {
            ...
            Log.w(A052, sb2);
            Point A02 = A02(c0305Cm, format);
            if (A02 != null) {
                i = Math.max(i, A02.x);
                i2 = Math.max(i2, A02.y);
                A00 = Math.max(A00, A01(c0305Cm, format.A0O, i, i2));
    ...
    private void A06() {
        MediaCodec A1C;
        this.A0R = false;
        if (C0430Hl.A02 >= 23 && this.A0S && (A1C = A1C()) != null) {
            this.A00 = new C0439Hw(this, A1C);
        }
    }
    ...
    private void A09() {
        ...
        if (this.A0E != this.A08 || this.A0C != this.A06 || this.A0D != this.A07 || this.A03 != this.A01) {
            ...
            i8.A01(this.A08, this.A06, this.A07, this.A01);
            this.A0E = this.A08;
            this.A0C = this.A06;
            this.A0D = this.A07;
            this.A03 = this.A01;
    ...
    public static void A0K(MediaFormat mediaFormat, int i) {
        mediaFormat.setFeatureEnabled(A05(1241, 17, j.AppCompatTheme_tooltipForegroundColor), true);
    ...
    private void A0L(Surface surface) throws AnonymousClass98 {
        ...
        if (this.A0O != surface) {
            ...
            if (A7U == 1 || A7U == 2) {
                MediaCodec A1C = A1C();
                if (C0430Hl.A02 >= 23 && A1C != null && surface != null && !this.A0Q) {
                    A0J(A1C, surface);
                } else {
                    A1G();
                    A1I();
    ...
    public static boolean A0M() {
        if (C0430Hl.A02 <= 22) {
            if (A05(948, 6, 4).equals(C0430Hl.A03)) {
                if (A05(545, 6, 122).equals(C0430Hl.A05)) {
                    return true;
                }
            }
        }
    ...
    private final boolean A0S(MediaCodec mediaCodec, int i, long j, long j2) throws AnonymousClass98 {
        int A0z = A0z(j2);
        if (A0z == 0) {
            return false;
        }
        C0261Ai c0261Ai = super.A0U;
        int droppedSourceBufferCount = c0261Ai.A03;
        c0261Ai.A03 = droppedSourceBufferCount + 1;
    ...
    private boolean A0T(C0305Cm c0305Cm) {
        if (C0430Hl.A02 >= 23 && !this.A0S) {
            String str = c0305Cm.A02;
            ...
            if (!A0U(str) && (!c0305Cm.A05 || DummySurface.A05(this.A0V))) {
                return true;
            }
        }
        return false;
    ...
    */
    ...
    public static boolean A0V(boolean z, Format format, Format format2) {
        if (format.A0O.equals(format2.A0O) && format.A0B == format2.A0B && (z || (format.A0F == format2.A0F && format.A08 == format2.A08))) {
            ...
            if (C0430Hl.A0g(colorInfo, colorInfo2)) {
                return true;
            }
        }
        return false;
    ...
    public final void A17(Format[] formatArr, long j) throws AnonymousClass98 {
        if (this.A0M == -9223372036854775807L) {
            ...
            if (i == this.A0Z.length) {
                Log.w(A05(522, 23, 23), A05(776, 45, j.AppCompatTheme_toolbarNavigationButtonStyle) + this.A0Z[this.A0A - 1]);
            } else {
                this.A0A = i + 1;
            }
            long[] jArr = this.A0Z;
    ...
    public final int A1A(MediaCodec mediaCodec, C0305Cm c0305Cm, Format format, Format format2) {
        if (A0V(c0305Cm.A03, format, format2) && format2.A0F <= this.A0P.A02 && format2.A08 <= this.A0P.A00 && A00(c0305Cm, format2) <= this.A0P.A01) {
    ...
    */
    ...
    public final void A1M(C0784Vn c0784Vn) {
        this.A04++;
        this.A0K = Math.max(c0784Vn.A00, this.A0K);
        if (C0430Hl.A02 < 23 && this.A0S) {
            A1R();
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.X.C3G
    public final void A1N(C0305Cm c0305Cm, MediaCodec mediaCodec, Format format, MediaCrypto mediaCrypto) throws C0314Cv {
        this.A0P = A04(c0305Cm, format, A19());
        ...
        if (this.A0O == null) {
            ...
            if (surface == null) {
                this.A0N = DummySurface.A01(this.A0V, c0305Cm.A05);
            }
            this.A0O = this.A0N;
        }
        mediaCodec.configure(A03, this.A0O, mediaCrypto, 0);
        if (C0430Hl.A02 >= 23 && this.A0S) {
            this.A00 = new C0439Hw(this, mediaCodec);
        }
    }
    ...
    */
    ...
    @Override // com.facebook.ads.redexgen.X.C3G
    public final boolean A1Q(C0305Cm c0305Cm) {
        return this.A0O != null || A0T(c0305Cm);
    }
