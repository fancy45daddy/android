...
public final class C0430Hl {
    ...
    static {
        ...
        sb.append(A02);
        A04 = sb.toString();
        A08 = Pattern.compile(A0J(33, 95, j.AppCompatTheme_textAppearanceSearchResultSubtitle));
    ...
    public static long A0I(long minPositionUs, C02379j c02379j, long j, long j2) {
        if (C02379j.A04.equals(c02379j)) {
            return minPositionUs;
        }
        long A0H = A0H(minPositionUs, c02379j.A01, Long.MIN_VALUE);
        long A0G = A0G(minPositionUs, c02379j.A00, Long.MAX_VALUE);
    ...
    public static ExecutorService A0T(String str) {
        return Executors.newSingleThreadExecutor(new ThreadFactoryC0429Hk(str));
    }
