...
public final class C00260t {
     ...
     */
    public final synchronized void A0A(String str) throws JSONException, C01887m {
        if (str != null) {
            if (!str.trim().isEmpty()) {
    ...
    private final synchronized C1O A00(String str, JSONObject jSONObject) throws JSONException, C01887m {
        C1O frequencyCappingData;
        if (str.equals(jSONObject.optString(A01(29, 12, j.AppCompatTheme_windowFixedWidthMajor), null))) {
            frequencyCappingData = new C1O(str);
            A03(frequencyCappingData, jSONObject);
        } else {
            C01887m c01887m = new C01887m(new IllegalArgumentException());
    ...
    private void A03(C1O c1o, JSONObject jSONObject) throws JSONException {
        ...
        int optInt2 = jSONObject.optInt(A01(j.AppCompatTheme_textAppearanceSearchResultSubtitle, 11, 91));
        ...
        if (jSONObject.has(A012)) {
            ...
            c1o.A04(cappingTimeSecs);
        }
        c1o.A05(optInt, optInt2, optLong, maxCappedArrayLength);
    }
    ...
    public final synchronized void A0B(JSONObject jSONObject) throws JSONException {
        C1O frequencyCappingData;
        String optString = jSONObject.optString(A01(29, 12, j.AppCompatTheme_windowFixedWidthMajor), null);
        if (optString == null) {
            return;
        }
        if (this.A00.has(optString) && (this.A00.get(optString) instanceof C1O)) {
            frequencyCappingData = (C1O) this.A00.get(optString);
        } else {
            frequencyCappingData = new C1O(optString);
        }
        A03(frequencyCappingData, jSONObject);
