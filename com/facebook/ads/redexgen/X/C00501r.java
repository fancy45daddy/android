...
public final class C00501r {
    ...
    public static AdSettings.IntegrationErrorMode A00(C0806Wj c0806Wj) {
        ...
        if (serializable == integrationErrorMode && !A03(c0806Wj)) {
    ...
    public static boolean A03(C0806Wj c0806Wj) {
        return (c0806Wj.getApplicationInfo().flags & 2) != 0;
    }
}
