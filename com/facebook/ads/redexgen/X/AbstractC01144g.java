...
public abstract class AbstractC01144g {
    ...
    public boolean A05;
    public int A00 = -1;
    public final C01124e A06 = new C01124e(0, 0);
    ...
    public abstract void A0H(int i, int i2, C01164i c01164i, C01124e c01124e);

    public abstract void A0I(View view, C01164i c01164i, C01124e c01124e);
    ...
    public void A04(int i, int i2) {
        ...
        if (!this.A05 || this.A00 == -1 || c0339Dw == null) {
            A09();
        }
        this.A04 = false;
        View view = this.A01;
        if (view != null) {
            ...
            strArr2[0] = "WYaFIbeKL";
            if (A00 == i3) {
                A0I(this.A01, c0339Dw.A0s, this.A06);
                C01124e c01124e = this.A06;
                if (A08[5].length() != 9) {
                    String[] strArr3 = A08;
                    strArr3[6] = "M";
                    strArr3[2] = "Q";
        ...
        if (this.A05) {
            A0H(i, i2, c0339Dw.A0s, this.A06);
            boolean hadJumpTarget = this.A06.A06();
            this.A06.A05(c0339Dw);
            if (hadJumpTarget) {
                if (this.A05) {
                    this.A04 = true;
                    c0339Dw.A08.A07();
    ...
    public final void A0D(C0339Dw c0339Dw, C4T c4t) {
        this.A03 = c0339Dw;
        this.A02 = c4t;
        if (this.A00 != -1) {
