...
public final class C00310y extends BroadcastReceiver {
    ...
    public C00310y(C0806Wj c0806Wj, String str, ZB zb, InterfaceC00300x interfaceC00300x) {
        this.A02 = c0806Wj;
        this.A03 = str;
        this.A01 = interfaceC00300x;
        this.A00 = zb;
    }
    ...
    public final void A02() {
        ...
        intentFilter.addAction(A00(135, 38, j.AppCompatTheme_windowFixedWidthMinor) + this.A03);
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        String intentAction = A00(0, 1, j.AppCompatTheme_toolbarNavigationButtonStyle);
        ...
        if (intentAction2.equals(str)) {
            this.A01.AAv(this.A00, null, true);
            return;
        }
        ...
        if (intentAction6.equals(str)) {
            this.A01.AB0(this.A00);
            return;
        }
        String intentAction7 = A00(331, 35, 0);
        if (intentAction7.equals(str)) {
            if (ID.A1J(context)) {
                this.A01.AAz(this.A00, AdError.AD_PRESENTATION_ERROR);
                return;
            } else {
                this.A01.AAz(this.A00, AdError.INTERNAL_ERROR);
                return;
            }
        }
        ...
        if (intentAction9.equals(str)) {
            InterfaceC00300x interfaceC00300x2 = this.A01;
            String[] strArr = A05;
        ...
        InterfaceC00300x interfaceC00300x3 = this.A01;
        String[] parts4 = A05;
        if (parts4[7].charAt(0) != 'P') {
            throw new RuntimeException();
        }
        A05[0] = "2dNMpRkIvORsTqY7tSIXPx";
        interfaceC00300x3.AB2();
    }
}
