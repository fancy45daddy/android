...
public final class C2D {
    ...
    static {
        A06();
        A03 = new String[]{A02(452, 7, 20), A02(459, 19, j.AppCompatTheme_textColorSearchUrl), A02(478, 25, 96), A02(503, 15, 30), A02(613, 9, 99), A02(622, 21, 8), A02(643, 27, 68), A02(670, 17, 53), A02(540, 21, 23), A02(418, 16, 83), A02(434, 18, 91), A02(398, 20, 78), A02(696, 20, j.AppCompatTheme_windowFixedWidthMajor), A02(352, 14, 46), A02(561, 25, j.AppCompatTheme_windowActionBarOverlay)};
    }
    ...
    private String A03(String str, String str2) {
        String A7a = this.A00.A7a(str, str2);
        if (A7a != null) {
            String value = A02(586, 4, 39);
            return A7a.equals(value) ? str2 : A7a;
        }
        return str2;
    }
    ...
    public static Map<String, String> A05(@Nullable String str) {
        ...
        try {
            ...
            if (A04(jSONObject.getString(A02(670, 17, 53))).size() == 0) {
                A08(C01877l.A27, new C01887m(A02(239, 20, j.AppCompatTheme_textAppearanceSearchResultSubtitle)));
                return null;
            } else if (A04(jSONObject.getString(A02(503, 15, 30))).size() == 0) {
                A08(C01877l.A24, new C01887m(A02(221, 18, 10)));
                return null;
            } else {
                return hashMap;
            }
        } catch (JSONException e) {
            A08(C01877l.A26, new C01887m(e));
            return null;
        }
    }
    ...
    private final void A07() {
        ...
        A56.ADK(A02(518, 22, j.AppCompatTheme_windowNoTitle), 0L);
        A56.A3N();
    }

    public static void A08(int i, C01887m c01887m) {
        C0805Wi sdkContext = C7F.A00();
        if (sdkContext != null) {
            sdkContext.A06().A8u(A02(687, 9, 5), i, c01887m);
        }
    }

    public final long A09() {
        return this.A00.A6s(A02(518, 22, j.AppCompatTheme_windowNoTitle), 0L);
    }
    ...
    public final String A0G() {
        return A03(A02(459, 19, j.AppCompatTheme_textColorSearchUrl), A02(268, 23, 59));
    }
    ...
    public final String A0I() {
        return A03(A02(561, 25, j.AppCompatTheme_windowActionBarOverlay), A02(0, 0, 94));
    }
    ...
    public final String A0M() {
        return A03(A02(696, 20, j.AppCompatTheme_windowFixedWidthMajor), A02(291, 21, 17));
    }
    ...
    public final void A0N(@Nullable String str) {
        ...
        C2I A56 = this.A00.A56();
        for (String str2 : A03) {
            A56.ADL(str2, A05.get(str2));
        }
        A56.ADK(A02(518, 22, j.AppCompatTheme_windowNoTitle), System.currentTimeMillis());
        A56.A3N();
    }

    public final boolean A0O(Context context, boolean z) {
        return (z || ID.A1r(context)) && ((A09() > 0L ? 1 : (A09() == 0L ? 0 : -1)) > 0);
    }
}
