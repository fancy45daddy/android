...
public class HandlerThreadC0435Hr extends HandlerThread implements Handler.Callback {
    ...
    public final boolean handleMessage(Message message) {
        ...
        try {
            ...
            try {
                ...
                Log.e(A00(0, 12, j.AppCompatTheme_windowFixedWidthMinor), A00(12, 34, 1), e);
                this.A03 = e;
                synchronized (this) {
                    notify();
                }
            } catch (RuntimeException e2) {
                Log.e(A00(0, 12, j.AppCompatTheme_windowFixedWidthMinor), A00(12, 34, 1), e2);
                this.A04 = e2;
                synchronized (this) {
                    notify();
                }
