...
public class C00973o {
    ...
    public C00973o(int i, int i2, int i3, Object obj) {
        this.A00 = i;
        this.A02 = i2;
        this.A01 = i3;
        this.A03 = obj;
        ...
        if (i != 1) {
            if (i != 2) {
                if (i != 4) {
                    ...
                    return A01(15, 2, j.AppCompatTheme_windowFixedHeightMajor);
                }
                return A01(19, 2, j.AppCompatTheme_tooltipFrameBackground);
            }
            return A01(17, 2, 31);
        }
        return A01(10, 3, 62);
    ...
    public final boolean equals(Object obj) {
        ...
        C00973o c00973o = (C00973o) obj;
        int i = this.A00;
        if (i != c00973o.A00) {
            return false;
        }
        if (i == 8 && Math.abs(this.A01 - this.A02) == 1 && this.A01 == c00973o.A02 && this.A02 == c00973o.A01) {
            return true;
        }
        if (this.A01 != c00973o.A01 || this.A02 != c00973o.A02) {
            return false;
        }
        Object obj2 = this.A03;
        if (obj2 != null) {
            if (!obj2.equals(c00973o.A03)) {
                return false;
            }
        } else {
            Object obj3 = c00973o.A03;
            if (A05[2].charAt(7) == 'q') {
                throw new RuntimeException();
            }
