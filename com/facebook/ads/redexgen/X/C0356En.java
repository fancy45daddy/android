...
public final class C0356En extends ZO {
    ...
    static {
        A01();
        A04 = C0356En.class.getSimpleName();
    }

    public C0356En(C0806Wj c0806Wj, IT it, String str, Uri uri, Map<String, String> mExtraData, @Nullable C00190m c00190m, boolean z) {
    ...
    public final EnumC00120e A0A() {
        ...
        try {
            KL.A0A(new KL(), ((AbstractC00130f) this).A00, KM.A00(this.A00.getQueryParameter(A00(25, 4, 35))), ((AbstractC00130f) this).A02);
            return null;
        } catch (Exception unused) {
            String str = A00(0, 25, j.AppCompatTheme_textAppearanceSearchResultSubtitle) + this.A00.toString();
