...
public final class C0415Gw {
     ...
     */
    /* JADX WARN: Not initialized variable reg: 3, insn: 0x0088: INVOKE  (r3 I:com.facebook.ads.redexgen.X.GQ) type: STATIC call: com.facebook.ads.redexgen.X.Hl.A0W(com.facebook.ads.redexgen.X.GQ):void, block:B:32:0x0088 */
    /* JADX WARN: Not initialized variable reg: 3, insn: 0x0092: INVOKE  (r3 I:com.facebook.ads.redexgen.X.GQ) type: STATIC call: com.facebook.ads.redexgen.X.Hl.A0W(com.facebook.ads.redexgen.X.GQ):void, block:B:36:0x0092 */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static long A00(com.facebook.ads.redexgen.X.GU r14, long r15, long r17, com.facebook.ads.redexgen.X.GQ r19, byte[] r20, @androidx.annotation.Nullable com.facebook.ads.redexgen.X.HZ r21, int r22, com.facebook.ads.redexgen.X.C0414Gv r23) throws java.io.IOException, java.lang.InterruptedException {
        /*
            r2 = r14
        L1:
            r1 = r21
        ...
        L82:
            ...
            throw r0     // Catch: com.facebook.ads.redexgen.X.HY -> L88 java.lang.Throwable -> L91
        L88:
            com.facebook.ads.redexgen.X.C0430Hl.A0W(r3)
            goto L1
        L8d:
            com.facebook.ads.redexgen.X.C0430Hl.A0W(r3)
            return r9
        L91:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0415Gw.A00(com.facebook.ads.redexgen.X.GU, long, long, com.facebook.ads.redexgen.X.GQ, byte[], com.facebook.ads.redexgen.X.HZ, int, com.facebook.ads.redexgen.X.Gv):long");
    }
    ...
    public static void A03(GU gu, InterfaceC0409Gq interfaceC0409Gq, C0723Tb c0723Tb, byte[] bArr, @Nullable HZ hz, int i, @Nullable C0414Gv c0414Gv, @Nullable AtomicBoolean atomicBoolean, boolean z) throws IOException, InterruptedException {
        long start;
        C0414Gv c0414Gv2 = c0414Gv;
        H6.A01(c0723Tb);
        H6.A01(bArr);
        if (c0414Gv2 != null) {
            A04(gu, interfaceC0409Gq, c0414Gv2);
        } else {
            c0414Gv2 = new C0414Gv();
        }
        String A02 = A02(gu);
        long j = gu.A01;
        long start2 = gu.A02;
        if (start2 != -1) {
            ...
            start = interfaceC0409Gq.A66(A02);
        }
        while (true) {
            long j2 = 0;
            if (start != 0) {
                ...
                long A5u = interfaceC0409Gq.A5u(A02, j, start != -1 ? start : Long.MAX_VALUE);
                if (A5u <= 0) {
                    long j3 = -A5u;
                    String[] strArr = A00;
                    ...
                    A00[2] = "OFDha7Ysfl6kB";
                    A5u = j3;
                    if (A00(gu, j, j3, c0723Tb, bArr, hz, i, c0414Gv2) < A5u) {
                        if (!z || start == -1) {
                            return;
                        }
    ...
    public static void A04(GU gu, InterfaceC0409Gq interfaceC0409Gq, C0414Gv c0414Gv) {
        long left;
        String A02 = A02(gu);
        long j = gu.A01;
        if (gu.A02 != -1) {
        ...
        c0414Gv.A02 = 0L;
        while (left != 0) {
            long A5u = interfaceC0409Gq.A5u(A02, j, left != -1 ? left : Long.MAX_VALUE);
            if (A5u > 0) {
                c0414Gv.A00 += A5u;
            } else {
                A5u = -A5u;
    ...
    public static void A05(InterfaceC0409Gq interfaceC0409Gq, String str) {
        for (C0413Gu c0413Gu : interfaceC0409Gq.A5v(str)) {
            if (A00[2].length() != 13) {
                throw new RuntimeException();
            }
            A00[4] = "R4HmvLUlpWi57h";
            try {
                interfaceC0409Gq.ADq(c0413Gu);
