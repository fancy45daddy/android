...
public final class C1L implements Serializable {
    ...
    public static String A01(String str) {
        if (A00(0, 4, j.AppCompatTheme_windowMinWidthMinor).equalsIgnoreCase(str)) {
            return A00(0, 0, 68);
        }
        return str;
    }
    ...
    private String A02(@Nullable JSONObject jSONObject) {
        ...
        return jSONObject.optString(A00(4, 3, j.AppCompatTheme_textAppearanceSearchResultSubtitle), A00);
    }
