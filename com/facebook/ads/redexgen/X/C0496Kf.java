...
public class C0496Kf implements InvocationHandler {
    ...
    public C0496Kf(int i, LinkedBlockingQueue linkedBlockingQueue, C7G c7g) {
        this.A00 = i;
        ...
        try {
            if (method.getName().equals(A00(34, 16, 122)) && objArr.length == 1 && (objArr[0] instanceof List)) {
                for (Object c : (List) objArr[0]) {
                    String str = (String) c.getClass().getMethod(A00(7, 12, j.AppCompatTheme_windowActionBar), new Class[0]).invoke(c, new Object[0]);
                    int intValue = ((Integer) c.getClass().getMethod(A00(19, 7, j.AppCompatTheme_windowMinWidthMinor), new Class[0]).invoke(c, new Object[0])).intValue();
            ...
            this.A01.A06().A8u(A00(0, 7, j.AppCompatTheme_toolbarNavigationButtonStyle), C01877l.A1G, new C01887m(t));
        }
        return null;
    }
}
