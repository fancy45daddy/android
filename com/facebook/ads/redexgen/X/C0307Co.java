...
public class C0307Co extends Exception {
    ...
    public C0307Co(Format format, Throwable th, boolean z, int i) {
    ...
    public C0307Co(Format format, Throwable th, boolean z, String str) {
        super(A01(2, 21, 92) + str + A01(0, 2, 21) + format, th);
        this.A02 = format.A0O;
        this.A03 = z;
        this.A00 = str;
        this.A01 = C0430Hl.A02 >= 21 ? A02(th) : null;
    }

    public static String A00(int i) {
        String A01 = i < 0 ? A01(j.AppCompatTheme_textAppearanceSearchResultSubtitle, 4, 95) : A01(0, 0, j.AppCompatTheme_textColorSearchUrl);
