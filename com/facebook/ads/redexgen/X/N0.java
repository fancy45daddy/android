...
public final class N0 extends Drawable {
    ...
    public String A06;
    @Nullable
    public WeakReference<C0627Pi> A07;
    public boolean A08;
    ...
    public final Runnable A0F = new C0686Rp(this);
    ...
    public static void A04() {
        A0G = new byte[]{65, 73, 21, 42, 38, 52, 121, 99, 24, 87, 94, 24, 81, 93, 49, 18, 28, 25, 24, 25, 93, 117, 109, 114, 113, 109, 115, 55, 21, 6, 16, 84, 86, 113, 118, 107, 118, 126, 115, 118, 101, 118, 113, 120, 49, 49, 49, 60, 11, 4, 79, 68, Byte.MAX_VALUE, 122, Byte.MAX_VALUE, 126, 102, Byte.MAX_VALUE, 108, 83, 95, 77, 91, 88, 83, 86, 83, 78, 67, 26, 121, 82, 95, 89, 81, 95, 72, 26, 84, 85, 78, 26, 73, 95, 78, 32, 104, 48, 125, 51, 96, 33, 39, 47};
    }
    ...
    public void A03() {
        ...
        int i = this.A00;
        String A02 = A02(0, 1, j.AppCompatTheme_windowFixedWidthMinor);
        if (i <= 0) {
            ...
            if (this.A03 > 0) {
                ...
                if (i2 > 0) {
                    sb.append(i2);
                    sb.append(A02(85, 2, j.AppCompatTheme_windowMinWidthMajor));
                }
                if (i2 > 0 || minutes > 0) {
                    sb.append(minutes);
        ...
        WeakReference<C0627Pi> weakReference = this.A07;
    ...
    public final void A0A(C0627Pi c0627Pi) {
        this.A07 = new WeakReference<>(c0627Pi);
        A03();
    }
