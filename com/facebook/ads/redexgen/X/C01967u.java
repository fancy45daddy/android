...
public final class C01967u {
    ...
    public static void A08(Context context) {
        ...
        A08.set(valueOf);
        A05.put(A01(92, 10, j.AppCompatTheme_windowActionBar), valueOf);
    }
    ...
    public static void A09(Context context) {
        ...
        A05.put(A01(61, 16, j.AppCompatTheme_textColorAlertDialogListItem), String.valueOf(memoryInfo.availMem));
        if (Build.VERSION.SDK_INT >= 16) {
            A05.put(A01(140, 12, j.AppCompatTheme_toolbarStyle), String.valueOf(memoryInfo.totalMem));
        }
    }
    ...
    public static void A0A(C7G c7g) {
        try {
            ...
            int intExtra = c7g.getIntExtra(A01(j.AppCompatTheme_tooltipFrameBackground, 5, 89), -1);
            ...
            A05.put(A01(77, 7, j.AppCompatTheme_windowActionModeOverlay), String.valueOf(f));
            A05.put(A01(84, 8, 75), z ? A01(1, 1, j.AppCompatTheme_windowFixedWidthMinor) : A01(0, 1, 33));
        } catch (IllegalArgumentException e) {
            c7g.A06().A8u(A01(j.AppCompatTheme_textAppearanceSearchResultTitle, 7, 57), C01877l.A1T, new C01887m(e));
        }
    }
    ...
    public static void A0C(Map<String, String> map) {
        ...
        if (fArr2 != null) {
            ...
            for (int i2 = 0; i2 < min2; i2++) {
                map.put(A01(j.AppCompatTheme_windowFixedHeightMajor, 9, 4) + A07[i2], String.valueOf(fArr2[i2]));
            }
        }
    }
}
