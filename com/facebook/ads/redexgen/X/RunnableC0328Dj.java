...
public final class RunnableC0328Dj implements Runnable {
    ...
    public final C0331Dm A05;
    public volatile int A06;
    public volatile InterfaceC0335Dq A07;
    ...
    public RunnableC0328Dj(int i, C0331Dm c0331Dm, DownloadAction downloadAction, int i2) {
        this.A02 = i;
        this.A05 = c0331Dm;
    ...
    public /* synthetic */ RunnableC0328Dj(int i, C0331Dm c0331Dm, DownloadAction downloadAction, int i2, RunnableC0320Db runnableC0320Db) {
        this(i, c0331Dm, downloadAction, i2);
    }
    ...
    public void A08() {
        ...
        handler.post(new RunnableC0325Dg(this));
    }
    ...
    public final C0330Dl A0K() {
        return new C0330Dl(this.A02, this.A04, A01(), A00(), A05(), this.A01, null);
    }
    ...
    public final void run() {
        ...
        try {
            C0331Dm.A0J(A07(59, 15, 54), this);
            Throwable finalError = null;
            try {
                DownloadAction downloadAction = this.A04;
                c0336Dr = this.A05.A0A;
                this.A07 = downloadAction.A07(c0336Dr);
                if (this.A04.A03) {
                    this.A07.remove();
                } else {
                    int i = 0;
                    ...
                    while (!Thread.interrupted()) {
                        try {
                            ...
                            if (errorPosition != j) {
                                C0331Dm.A0J(A07(22, 37, 92) + errorPosition, this);
                                j = errorPosition;
                                i = 0;
                            }
                            if (this.A06 == 1 && (i = i + 1) <= this.A03) {
                                C0331Dm.A0J(A07(0, 22, 20) + i, this);
            ...
            handler = this.A05.A07;
            handler.post(new RunnableC0326Dh(this, finalError));
        } catch (Throwable th2) {
