...
public abstract class AbstractC00622d<K, V> {
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [com.facebook.ads.redexgen.X.2c] */
        ...
        if (this.A02 == null) {
            this.A02 = new Collection<V>() { // from class: com.facebook.ads.redexgen.X.2c
                ...
                public final boolean removeAll(Collection<?> collection) {
                    int A04 = AbstractC00622d.this.A04();
                    boolean z = false;
                    int i = 0;
                    while (i < A04) {
                        if (collection.contains(AbstractC00622d.this.A07(i, 1))) {
                            AbstractC00622d.this.A0E(i);
                            i--;
                            A04--;
                            z = true;
                        }
                ...
                public final void clear() {
                    AbstractC00622d.this.A0D();
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2c != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$ValuesCollection */
                @Override // java.util.Collection
                public final boolean contains(Object obj) {
                    return AbstractC00622d.this.A06(obj) >= 0;
                }
                ...
                public final boolean isEmpty() {
                    return AbstractC00622d.this.A04() == 0;
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2c != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$ValuesCollection */
                @Override // java.util.Collection, java.lang.Iterable
                public final Iterator<V> iterator() {
                    return new C2Y(AbstractC00622d.this, 1);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2c != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$ValuesCollection */
                @Override // java.util.Collection
                public final boolean remove(Object obj) {
                    int A06 = AbstractC00622d.this.A06(obj);
                    if (A06 >= 0) {
                        AbstractC00622d.this.A0E(A06);
                        return true;
                ...
                public final int size() {
                    return AbstractC00622d.this.A04();
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2c != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$ValuesCollection */
                @Override // java.util.Collection
                public final Object[] toArray() {
                    return AbstractC00622d.this.A0G(1);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2c != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$ValuesCollection */
                @Override // java.util.Collection
                public final <T> T[] toArray(T[] array) {
                    return (T[]) AbstractC00622d.this.A0H(array, 1);
                }
            };
        }
        return this.A02;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2d != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V> */
    /* JADX WARN: Type inference failed for: r0v7, types: [com.facebook.ads.redexgen.X.2Z] */
            ...
            this.A00 = new Set<Map.Entry<K, V>>() { // from class: com.facebook.ads.redexgen.X.2Z
                ...
                public final boolean addAll(Collection<? extends Map.Entry<K, V>> collection) {
                    ...
                    while (it.hasNext()) {
                        ...
                        AbstractC00622d.this.A0F(entry.getKey(), entry.getValue());
                    }
                    return A04 != AbstractC00622d.this.A04();
                }
                ...
                public final boolean contains(Object obj) {
                    if (obj instanceof Map.Entry) {
                        ...
                        int index = AbstractC00622d.this.A05(entry.getKey());
                        if (index < 0) {
                            return false;
                        }
                        Object foundVal = AbstractC00622d.this.A07(index, 1);
                ...
                public final boolean equals(Object obj) {
                    return AbstractC00622d.A03(this, obj);
                }
                ...
                public final int hashCode() {
                    int i = 0;
                    for (int A04 = AbstractC00622d.this.A04() - 1; A04 >= 0; A04--) {
                        int i2 = 0;
                        Object A07 = AbstractC00622d.this.A07(A04, 0);
                        Object A072 = AbstractC00622d.this.A07(A04, 1);
                ...
                public final Iterator<Map.Entry<K, V>> iterator() {
                    return new C00602b(AbstractC00622d.this);
                }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2d != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V> */
    /* JADX WARN: Type inference failed for: r0v2, types: [com.facebook.ads.redexgen.X.2a] */
    public final Set<K> A0C() {
        if (this.A01 == null) {
            this.A01 = new Set<K>() { // from class: com.facebook.ads.redexgen.X.2a
                ...
                @Override // java.util.Set, java.util.Collection
                public final boolean contains(Object obj) {
                    return AbstractC00622d.this.A05(obj) >= 0;
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2a != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final boolean containsAll(Collection<?> collection) {
                    return AbstractC00622d.A00(AbstractC00622d.this.A0A(), collection);
                }
                ...
                public final int hashCode() {
                    int i = 0;
                    int result = AbstractC00622d.this.A04();
                    for (int i2 = result - 1; i2 >= 0; i2--) {
                        int i3 = 0;
                        Object A07 = AbstractC00622d.this.A07(i2, 0);
                        if (A07 != null) {
                            i3 = A07.hashCode();
                        }
                        i += i3;
                ...
                public final Iterator<K> iterator() {
                    return new C2Y(AbstractC00622d.this, 0);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2a != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final boolean remove(Object obj) {
                    int A05 = AbstractC00622d.this.A05(obj);
                    if (A05 >= 0) {
                        AbstractC00622d.this.A0E(A05);
                        return true;
                    }
                    return false;
                }
                ...
                @Override // java.util.Set, java.util.Collection
                public final boolean removeAll(Collection<?> collection) {
                    return AbstractC00622d.A01(AbstractC00622d.this.A0A(), collection);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2a != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final boolean retainAll(Collection<?> collection) {
                    return AbstractC00622d.A02(AbstractC00622d.this.A0A(), collection);
                }
                ...
                @Override // java.util.Set, java.util.Collection
                public final Object[] toArray() {
                    return AbstractC00622d.this.A0G(0);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2a != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final <T> T[] toArray(T[] array) {
                    return (T[]) AbstractC00622d.this.A0H(array, 0);
                }
            };
        }
        return this.A01;
