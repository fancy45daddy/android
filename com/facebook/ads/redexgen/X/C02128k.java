...
public final class C02128k implements Closeable {
    ...
    public final C02028a A01;
    public final Deque<C02118j> A02 = new LinkedList();
    ...
    public static String A02(int i, int i2, int i3) {
        ...
        for (int i4 = 0; i4 < copyOfRange.length; i4++) {
            ...
            copyOfRange[i4] = (byte) (i5 ^ j.AppCompatTheme_windowActionModeOverlay);
        }
    ...
    public C02128k(C02028a c02028a, InterfaceC02108i interfaceC02108i) throws IOException {
        this.A01 = c02028a;
        A05(c02028a, interfaceC02108i);
        if (this.A02.isEmpty()) {
            A00();
        }
    }

    private C02118j A00() throws IOException {
        int i = -1;
        if (!this.A02.isEmpty()) {
            i = this.A02.getLast().A00();
        }
        int i2 = i + 1;
        this.A02.add(new C02118j(i2, new C02088g(new File(this.A01.A05(), A01(i2)))));
    ...
    private void A04(int i, File file) throws IOException {
        C02088g c02088g = new C02088g(file);
        c02088g.A05();
        this.A02.addFirst(new C02118j(i, c02088g));
    }

    private void A05(C02028a c02028a, InterfaceC02108i interfaceC02108i) throws IOException {
        File[] listFiles = c02028a.A05().listFiles();
        if (listFiles != null) {
            ...
            for (File file : listFiles) {
                try {
                    ...
                    hashSet.add(file);
                    interfaceC02108i.ADw(String.format(Locale.US, A02(260, 39, 79), file.getCanonicalPath()));
                }
            }
            if (!hashMap.isEmpty()) {
                int i2 = i;
                ...
                while (it.hasNext()) {
                    ...
                    if (minFileNumber < i2) {
                        interfaceC02108i.ADw(String.format(Locale.US, A02(166, 61, 2), Integer.valueOf(minFileNumber), Integer.valueOf(i2)));
                ...
                while (i >= i2) {
                    ...
                    try {
                        ...
                        interfaceC02108i.ADx(String.format(Locale.US, A02(j.AppCompatTheme_textColorAlertDialogListItem, 62, 43), file2.getCanonicalPath(), Integer.valueOf(i)), e);
            ...
            for (File file3 : hashSet) {
                if (!file3.delete()) {
                    interfaceC02108i.ADw(String.format(Locale.US, A02(40, 26, 29), file3.getCanonicalPath()));
                }
            }
            return;
        }
        throw new IOException(String.format(Locale.US, A02(66, 38, 93), c02028a.A05().getCanonicalPath()));
    }
    ...
    public final synchronized C8Y A0A(int i, int i2, byte[] bArr, int i3, int[] iArr, int i4) throws IOException {
        if (!this.A00) {
            for (C02118j file : this.A02) {
                if (file.A00() == i) {
                    return new C8Y(i, file.A02(i2, bArr, i3, iArr, i4));
                }
            }
