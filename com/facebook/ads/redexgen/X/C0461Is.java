...
public final class C0461Is implements NativeAdRatingApi {
    ...
    public C0461Is(double d, double d2) {
        this.A01 = d;
        this.A00 = d2;
    }

    @Nullable
    public static C0461Is A00(@Nullable JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        if (A03[1].length() == 15) {
            ...
            if (optDouble != 0.0d) {
                ...
                if (A03[5].charAt(0) == 'R') {
                    ...
                    if (i != 0) {
                        return new C0461Is(optDouble, optDouble2);
                    }
                }
            }
            return null;
