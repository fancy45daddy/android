...
public final class C0627Pi {
    ...
    public int A02;
    public long A03;
    public AbstractRunnableC0487Ju A04;
    public C0628Pj A05;
    ...
    public final C0806Wj A0D;
    public final WeakReference<AbstractC0626Ph> A0E;
    ...
    */
    public static int A08(java.util.Vector<android.graphics.Rect> r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0627Pi.A08(java.util.Vector):int");
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 9 out of bounds for length 9
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public static C0628Pj A0E(View view, int i, C0806Wj c0806Wj) {
        if (view == null) {
            A0N(null, false, A0H(353, 16, 31));
            return new C0628Pj(C0Q.A08);
        }
        boolean A1z = ID.A1z(c0806Wj);
        String A0H2 = A0H(415, 37, j.AppCompatTheme_windowActionModeOverlay);
        String A0H3 = A0H(331, 22, 99);
        if (A1z) {
            if (view.getParent() == null) {
                A0N(view, false, A0H3);
                return new C0628Pj(C0Q.A0K);
            } else if (!view.isShown()) {
                A0N(view, false, A0H2);
                return new C0628Pj(C0Q.A0N);
            }
        } else if (view.getParent() == null) {
            A0N(view, false, A0H3);
            return new C0628Pj(C0Q.A0H);
        } else if (!view.isShown()) {
            A0N(view, false, A0H2);
            return new C0628Pj(C0Q.A0H);
        }
            ...
            if (A0H[4].charAt(15) == 'A') {
                ...
                try {
                    ...
                    if (!view.getGlobalVisibleRect(rect)) {
                        return new C0628Pj(C0Q.A07);
                    }
                    int i2 = Build.VERSION.SDK_INT;
                    if (A0H[1].length() == 16) {
                        A0H[1] = "Od97VXu84qI514kY";
                        if (i2 >= 17) {
                            ((WindowManager) c0806Wj.getSystemService(A0H(594, 6, j.AppCompatTheme_tooltipFrameBackground))).getDefaultDisplay().getRealMetrics(new DisplayMetrics());
                        } else {
                        ...
                        if (A082 < A01) {
                            ...
                            return new C0628Pj(C0Q.A04, A082);
                        } else if (!LV.A03(c0806Wj)) {
                            A0N(view, false, A0H(185, 26, 62));
                            return new C0628Pj(C0Q.A0L, A082);
                        } else {
                            Map<String, String> A012 = LW.A01(c0806Wj);
                            if (LF.A04(A012)) {
                                A0N(view, false, A0H(156, 29, 77));
                                return new C0628Pj(C0Q.A0A, A082);
                            } else if (ID.A1P(c0806Wj) && LF.A03(A012)) {
                                A0N(view, false, A0H(31, 31, 14));
                                return new C0628Pj(C0Q.A05, A082, A012);
                            } else {
                                A0N(view, true, A0H(396, 19, 63));
                                return new C0628Pj(C0Q.A0J, A082, A012);
                            }
                        }
                    }
    ...
    static {
        A0M();
        A0I = C0627Pi.class.getSimpleName();
    }

    public C0627Pi(View view, int i, int i2, boolean z, WeakReference<AbstractC0626Ph> weakReference, C0806Wj c0806Wj) {
        this.A0B = new Handler();
        this.A01 = 0;
        this.A02 = 1000;
        this.A08 = true;
        this.A05 = new C0628Pj(C0Q.A0M);
    ...
    public C0627Pi(View view, int i, WeakReference<AbstractC0626Ph> weakReference, C0806Wj c0806Wj) {
        this(view, i, 0, false, weakReference, c0806Wj);
    }

    public C0627Pi(View view, int i, boolean z, WeakReference<AbstractC0626Ph> weakReference, C0806Wj c0806Wj) {
        this(view, i, 0, z, weakReference, c0806Wj);
    }
    ...
    public static /* synthetic */ int A05(C0627Pi c0627Pi) {
        int i = c0627Pi.A00;
        c0627Pi.A00 = i + 1;
        return i;
    }
    ...
    public static Vector<Rect> A0K(View view) {
        ...
        for (int indexOfChild = viewGroup.indexOfChild(view) + 1; indexOfChild < viewGroup.getChildCount(); indexOfChild++) {
            ...
            int childIndex = 0;
            boolean z = !(childAt instanceof OU);
            childIndex = ((childAt instanceof RI) && C0629Pk.A00(childAt)) ? 1 : 1;
            if (z && childIndex != 0) {
    ...
    public static Vector<Rect> A0L(View view) {
        ...
        if ((view instanceof ViewGroup) && (C0629Pk.A00(view) || isTransparentToolbar)) {
    ...
    public static void A0N(View view, boolean z, String str) {
        if (BuildConfigApi.isDebug()) {
            ...
            sb.append(A0H(240, 5, j.AppCompatTheme_viewInflaterClass));
            sb.append(view);
            sb.append(A0H(9, 4, j.AppCompatTheme_tooltipForegroundColor));
