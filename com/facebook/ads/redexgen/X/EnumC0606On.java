...
public enum EnumC0606On {
    A06(j.AppCompatTheme_textAppearanceSearchResultSubtitle),
    A09(j.AppCompatTheme_textAppearanceSearchResultTitle),
    A0A(j.AppCompatTheme_textAppearanceSmallPopupMenu),
    A07(j.AppCompatTheme_textColorAlertDialogListItem),
    A08(j.AppCompatTheme_textColorSearchUrl),
    A05(j.AppCompatTheme_toolbarNavigationButtonStyle),
    A04(j.AppCompatTheme_toolbarStyle),
    A03(j.AppCompatTheme_tooltipForegroundColor);
