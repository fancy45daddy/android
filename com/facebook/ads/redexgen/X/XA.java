...
public class XA extends AbstractC00772t {
    ...
    @Override // com.facebook.ads.redexgen.X.AbstractC00772t
    ...
    public final Object A08(ViewGroup viewGroup, int i) {
        ...
        if (adViewProvider != null) {
            ...
            type = this.A01.A02;
            if (type != null) {
                c0806Wj2 = this.A01.A06;
                type2 = this.A01.A02;
                nativeAdViewAttributes2 = this.A01.A03;
                adView = NativeAdView.render(c0806Wj2, this.A00.get(i), type2, nativeAdViewAttributes2);
            } else {
                c0806Wj = this.A01.A06;
                nativeAdViewAttributes = this.A01.A03;
                adView = NativeAdView.render(c0806Wj, this.A00.get(i), nativeAdViewAttributes);
            }
        }
    ...
    public final void A0D() {
        ...
        for (int i2 = 0; i2 < min; i2++) {
            ...
            C0718Sw.A0L(ad.getInternalNativeAd()).A1a(true);
            this.A00.add(ad);
        }
        A09();
    }
