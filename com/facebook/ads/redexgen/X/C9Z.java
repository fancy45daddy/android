...
public final class C9Z extends P1 {
    ...
    public final AbstractC0534Lr A0B;
    public final AbstractC0501Kk A0C;
    public final K6 A0D;
    ...
    public C9Z(C0806Wj c0806Wj) {
        super(c0806Wj);
        this.A0E = UUID.randomUUID().toString();
        this.A0D = new A1(this);
        this.A0C = new AbstractC0501Kk() { // from class: com.facebook.ads.redexgen.X.9u
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.facebook.ads.redexgen.X.C8O
            /* renamed from: A00 */
            public final void A03(C01736s c01736s) {
                InterfaceC0527Lk interfaceC0527Lk;
                InterfaceC0527Lk interfaceC0527Lk2;
                interfaceC0527Lk = C9Z.this.A03;
                if (interfaceC0527Lk != null) {
                    interfaceC0527Lk2 = C9Z.this.A03;
                    interfaceC0527Lk2.onPause();
                }
            }
        };
        this.A0B = new AbstractC0534Lr() { // from class: com.facebook.ads.redexgen.X.9f
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.facebook.ads.redexgen.X.C8O
            /* renamed from: A00 */
            public final void A03(C6v c6v) {
                ...
                if (interfaceC0527Lk != null) {
                    interfaceC0527Lk2 = C9Z.this.A03;
                    interfaceC0527Lk2.AAF();
                }
            }
        };
        this.A09 = new AnonymousClass16(this, c0806Wj);
        this.A0A = c0806Wj;
        A02();
    }

    public C9Z(C0806Wj c0806Wj, AttributeSet attributeSet) {
    ...
    public C9Z(C0806Wj c0806Wj, AttributeSet attributeSet, int i) {
    ...
    private void A04(Intent intent) {
        if (this.A05 == null) {
            A05(A01(j.AppCompatTheme_windowFixedHeightMajor, 25, 19));
        } else if (this.A00 == null && this.A08 == null) {
            A05(A01(139, 37, 19));
        } else {
            intent.putExtra(A01(237, 18, 83), this.A07);
            intent.putExtra(A01(322, 8, 34), EnumC0471Jc.A06);
            ...
            intent.putExtra(A01(295, 27, j.AppCompatTheme_windowMinWidthMajor), getVideoProgressReportIntervalMs());
            intent.addFlags(268435456);
        }
    }

    private void A05(String str) {
        InterfaceC01867k A06 = this.A0A.A06();
        int i = C01877l.A27;
        String defaultErrorMessage = AdErrorType.PARSER_FAILURE.getDefaultErrorMessage();
        A06.A8u(A01(198, 7, j.AppCompatTheme_windowNoTitle), i, new C01887m(defaultErrorMessage, A01(90, 7, 93) + str));
    ...
    public final void A0n() {
        ...
        try {
            ...
            this.A0A.A06().A8u(A01(176, 11, 126), C01877l.A0D, new C01887m(e));
            Log.e(A01(97, 17, 22), A01(0, 90, 38), e);
        }
    }

    @Nullable
    public InterfaceC0527Lk getListener() {
        return this.A03;
    }
    ...
    public void setClientToken(@Nullable String str) {
        C01756y c01756y;
        C0602Oj c0602Oj = this.A04;
        if (c0602Oj != null) {
            c0602Oj.A0A();
        }
        C01756y c01756y2 = this.A05;
        if (c01756y2 != null) {
            c01756y2.A0g();
        }
        this.A06 = str;
        C0602Oj c0602Oj2 = null;
        if (str != null) {
            c01756y = new C01756y(this.A0A, this.A02, this, str);
        } else {
            c01756y = null;
        }
        this.A05 = c01756y;
        if (ID.A1L(this.A0A)) {
            if (str != null) {
                c0602Oj2 = new C0602Oj(this.A0A, this.A02, this, str, null);
            }
            this.A04 = c0602Oj2;
            return;
        }
    ...
    public void setListener(@Nullable InterfaceC0527Lk interfaceC0527Lk) {
        this.A03 = interfaceC0527Lk;
    }
