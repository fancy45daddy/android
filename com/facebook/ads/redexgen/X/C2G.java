...
public final class C2G {
    ...
    public final void A04() {
        ...
        C0444Ib c0444Ib = this.A00;
        if (c0444Ib != null) {
            c0444Ib.A02(EnumC0443Ia.A0B, null);
        }
    }
    ...
    public final void A06() {
        this.A02.add(A00(59, 20, j.AppCompatTheme_windowMinWidthMajor));
        C0444Ib c0444Ib = this.A00;
        if (c0444Ib != null) {
            c0444Ib.A02(EnumC0443Ia.A0C, null);
        }
    }
    ...
    public final void A08(C2F c2f) {
        ...
        C0444Ib c0444Ib = this.A00;
        if (c0444Ib != null) {
            c0444Ib.A02(EnumC0443Ia.A09, null);
        }
    }

    public final void A09(C2F c2f, int i) {
        List<String> list = this.A02;
        list.add(c2f.A02() + A00(0, 1, j.AppCompatTheme_windowFixedHeightMajor) + i);
    }
