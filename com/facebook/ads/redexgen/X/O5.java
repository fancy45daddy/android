...
public enum O5 {
    ...
    A0E(A01(351, 24, 96)),
    A03(A01(244, 13, 76)),
    A06(A01(281, 18, j.AppCompatTheme_textColorSearchUrl)),
    A05(A01(262, 19, 19)),
    A0D(A01(341, 10, 39)),
    A0F(A01(375, 3, 12)),
    A04(A01(257, 5, 2)),
    A09(A01(304, 6, 81)),
    A0H(A01(388, 10, 14)),
    A0M(A01(457, 15, j.AppCompatTheme_windowMinWidthMinor)),
    A07(A01(299, 5, 1)),
    A0G(A01(378, 10, 20)),
    A0C(A01(331, 10, 83)),
    A0N(A01(472, 10, 4)),
    A0K(A01(418, 10, 38)),
    A0J(A01(407, 11, 121)),
    A0P(A01(482, 12, j.AppCompatTheme_textAppearanceSearchResultTitle)),
    A0L(A01(446, 11, 11)),
    A0B(A01(320, 11, 93)),
    A08(A01(428, 18, 20)),
    A0I(A01(398, 9, 16)),
    A0O(A01(0, 0, j.AppCompatTheme_toolbarStyle));
    ...
    public static O5 A00(String str) {
        O5[] values;
        for (O5 o5 : values()) {
            if (o5.A00.equalsIgnoreCase(str)) {
                return o5;
            }
        }
        return A0O;
