...
public final class C1V {
    ...
    public static C00341b A01(JSONObject jSONObject) {
        return new C00331a().A02(A08(jSONObject)).A03(A09(jSONObject)).A04();
    }
    ...
    public static String A04(JSONObject jSONObject) {
        JSONObject optJSONObject = jSONObject.optJSONObject(A02(217, 12, 62));
        String A02 = A02(0, 8, j.AppCompatTheme_viewInflaterClass);
        return optJSONObject == null ? A02 : optJSONObject.optString(A02(150, 8, 90), A02);
    }
