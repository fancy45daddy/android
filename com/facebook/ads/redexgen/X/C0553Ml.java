...
public class C0553Ml implements InterfaceC0514Kx<Bundle> {
    ...
    public final IT A06;
    public final InterfaceC0604Ol A07;
    public final InterfaceC0609Oq A08;
    public final C0610Or A09;
     ...
     */
    public C0553Ml(C0806Wj c0806Wj, IT it, InterfaceC0604Ol interfaceC0604Ol, List<C2A> list, String str, boolean z, @Nullable Bundle bundle, @Nullable Map<String, String> map, InterfaceC0609Oq interfaceC0609Oq) {
        this.A0A = new Object();
        this.A01 = 0;
        this.A00 = 0;
        this.A02 = null;
        this.A05 = c0806Wj;
        this.A06 = it;
        this.A07 = interfaceC0604Ol;
        this.A0B = str;
        this.A0C = map;
        this.A03 = z;
        this.A08 = interfaceC0609Oq;
        ...
        this.A09 = new C0610Or(new Handler(), this);
    }
    ...
    public C0553Ml(C0806Wj c0806Wj, IT it, InterfaceC0604Ol interfaceC0604Ol, List<C2A> list, String str, boolean z, @Nullable Bundle bundle, InterfaceC0609Oq interfaceC0609Oq) {
        this(c0806Wj, it, interfaceC0604Ol, list, str, z, bundle, null, interfaceC0609Oq);
    }

    public C0553Ml(C0806Wj c0806Wj, IT it, InterfaceC0604Ol interfaceC0604Ol, List<C2A> list, String str, boolean z, InterfaceC0609Oq interfaceC0609Oq) {
        this(c0806Wj, it, interfaceC0604Ol, list, str, z, null, interfaceC0609Oq);
    }
    ...
    private Map<String, String> A0I(int i) {
        ...
        LB.A03(hashMap, this.A07.getVideoStartReason() == EnumC0611Os.A02, !this.A07.A8T());
        A0S(hashMap);
        A0R(hashMap);
        A0U(hashMap, i);
        A0T(hashMap);
    ...
    public Map<String, String> A0J(EnumC0605Om enumC0605Om) {
        return A0K(enumC0605Om, this.A07.getCurrentPositionInMillis());
    }

    private Map<String, String> A0K(EnumC0605Om enumC0605Om, int i) {
        Map<String, String> A0I = A0I(i);
        A0I.put(A0G(0, 6, 122), String.valueOf(enumC0605Om.A00));
        return A0I;
    }

    private void A0M() {
        this.A06.A9L(this.A0B, A0J(EnumC0605Om.A04));
    }

    private void A0N() {
        this.A06.A9L(this.A0B, A0J(EnumC0605Om.A0A));
    }
    ...
    private final void A0P(int i, boolean z, boolean z2) {
        ...
        if (i > i2) {
            ...
            if (z2 || i - this.A00 >= 5000) {
                IT it = this.A06;
                String str = this.A0B;
                Map<String, String> A0K = A0K(EnumC0605Om.A09, i);
                if (A0E[5].length() == 0) {
        ...
        if (z) {
            this.A06.A9L(this.A0B, A0K(EnumC0605Om.A09, i));
        }
    }
    ...
    private void A0R(Map<String, String> params) {
        ...
        C2B A01 = A03.A01();
        params.put(A0G(j.AppCompatTheme_viewInflaterClass, 3, 127), String.valueOf(A01.A00()));
        params.put(A0G(j.AppCompatTheme_windowActionModeOverlay, 3, 74), String.valueOf(A01.A05()));
        params.put(A0G(j.AppCompatTheme_windowFixedWidthMajor, 5, j.AppCompatTheme_tooltipFrameBackground), String.valueOf(A01.A02()));
    ...
    private void A0T(Map<String, String> params) {
        ...
        params.put(A0G(89, 2, j.AppCompatTheme_windowFixedWidthMajor), String.valueOf(this.A07.getMeasuredHeight()));
        params.put(A0G(j.AppCompatTheme_textColorAlertDialogListItem, 2, 123), String.valueOf(this.A07.getMeasuredWidth()));
    ...
    private void A0U(Map<String, String> map, int i) {
        map.put(A0G(99, 5, j.AppCompatTheme_tooltipFrameBackground), String.valueOf(this.A00 / 1000.0f));
        map.put(A0G(j.AppCompatTheme_toolbarNavigationButtonStyle, 4, 5), String.valueOf(i / 1000.0f));
    }
    ...
    public final void A0X() {
        this.A06.A9L(this.A0B, A0J(EnumC0605Om.A07));
    }

    public final void A0Y() {
        this.A06.A9L(this.A0B, A0J(EnumC0605Om.A08));
    }
    ...
    public final void A0c(int i) {
        this.A04.A04();
        this.A06.A9L(this.A0B, A0J(EnumC0605Om.A05));
