...
public class AnonymousClass48 {
    ...
    public List<AbstractC01194l> A08 = null;
    ...
    public final View A03(C01094b c01094b) {
        if (this.A08 != null) {
            return A00();
        }
        View A0G = c01094b.A0G(this.A01);
        this.A01 += this.A03;
        return A0G;
    }
    ...
    public final boolean A05(C01164i c01164i) {
        int i = this.A01;
        return i >= 0 && i < c01164i.A03();
    }
}
