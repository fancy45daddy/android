...
public final class C0877Ze implements AnonymousClass03<Bitmap> {
    ...
    public final String A02 = C0877Ze.class.getSimpleName();
    ...
    public C0877Ze(int i, int i2, boolean z, boolean z2, boolean z3) {
        this.A01 = i;
        this.A00 = i2;
        this.A05 = z;
        this.A03 = z2;
    ...
    public final void A4B(File file, C0L c0l) throws ZY {
        if (this.A03) {
            try {
                ...
                c0l.A8y(th);
                Throwable t = new ZY(A01(18, 33, 49), th);
                throw t;
            }
        }
    }
