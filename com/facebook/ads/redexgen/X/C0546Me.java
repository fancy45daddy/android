...
public final class C0546Me extends LinearLayout {
    ...
    public InterfaceC0545Md A04;
    public C0552Mk A05;
    public String A06;
    public boolean A07;
    public final WebView A08;
    public final InterfaceC0555Mn A09;
    ...
    public C0546Me(C0806Wj c0806Wj, WebView webView) {
        super(c0806Wj);
        this.A09 = new S0(this);
        this.A08 = webView;
        this.A07 = IE.A06(c0806Wj);
        A08(c0806Wj);
    }
    ...
    private void A08(C0806Wj c0806Wj) {
        ...
        if (this.A07) {
            ...
            this.A00.setOnClickListener(new View$OnClickListenerC0542Ma(this));
            addView(this.A00, closeButtonParams2);
        }
        this.A05 = new C0552Mk(c0806Wj);
        ...
        if (this.A07) {
            ...
            this.A02.setOnClickListener(new View$OnClickListenerC0543Mb(this));
        ...
        this.A03.setContentDescription(A05(16, 19, j.AppCompatTheme_textAppearanceSearchResultTitle));
        this.A03.setScaleType(ImageView.ScaleType.CENTER);
        this.A03.setOnTouchListener(A0F);
        this.A03.setOnClickListener(new View$OnClickListenerC0544Mc(this, c0806Wj));
        addView(this.A03, nativeButtonParams);
        setupDefaultNativeBrowser(c0806Wj);
    }

    public InterfaceC0555Mn getBrowserNavigationListener() {
        return this.A09;
    }

    public void setListener(InterfaceC0545Md interfaceC0545Md) {
        this.A04 = interfaceC0545Md;
    }
    ...
    private void setupDefaultNativeBrowser(C0806Wj c0806Wj) {
        Bitmap A01;
        List<ResolveInfo> queryIntentActivities = c0806Wj.getPackageManager().queryIntentActivities(new Intent(A05(46, 26, 84), A0E), 65536);
