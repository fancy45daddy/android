...
public final class NO extends LinearLayout {
    ...
    public NO(C0806Wj c0806Wj, C1K c1k, boolean z, int i, int i2, int i3) {
        super(c0806Wj);
        setOrientation(1);
        this.A02 = new TextView(c0806Wj);
        LE.A0X(this.A02, true, i);
        this.A02.setEllipsize(TextUtils.TruncateAt.END);
        this.A02.setLineSpacing(A06, 1.0f);
        this.A01 = new TextView(c0806Wj);
        this.A00 = new TextView(c0806Wj);
        LE.A0X(this.A00, false, i2);
    ...
    */
    public NO(com.facebook.ads.redexgen.X.C0806Wj r8, com.facebook.ads.redexgen.X.C1K r9, boolean r10, boolean r11, boolean r12) {
        /*
            r7 = this;
            if (r11 == 0) goto L19
            r4 = 18
