...
public final class C0305Cm {
    ...
    public C0305Cm(String str, @Nullable String str2, @Nullable MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2, boolean z3) {
    ...
    public static int A00(String str, String str2, int i) {
        ...
        if (i <= 1) {
            ...
            if (strArr[3].length() == strArr[4].length()) {
                ...
                if (i3 < 26 || i <= 0) {
                    if (!A03(226, 10, 23).equals(str2) && !A03(121, 10, 22).equals(str2) && !A03(140, 12, 57).equals(str2) && !A03(211, 15, j.AppCompatTheme_windowMinWidthMinor).equals(str2) && !A03(255, 12, 11).equals(str2) && !A03(236, 10, j.AppCompatTheme_viewInflaterClass).equals(str2) && !A03(246, 9, j.AppCompatTheme_windowMinWidthMajor).equals(str2)) {
                        ...
                        if (strArr3[0].length() != strArr3[5].length()) {
                            ...
                            if (!A03.equals(str2) && !A03(172, 15, j.AppCompatTheme_textColorSearchUrl).equals(str2) && !A03(187, 15, 4).equals(str2) && !A03(202, 9, 47).equals(str2)) {
    ...
    public static C0305Cm A01(String str) {
        return new C0305Cm(str, null, null, true, false, false);
    }

    public static C0305Cm A02(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2) {
        return new C0305Cm(str, str2, codecCapabilities, false, z, z2);
    }
    ...
    public static boolean A09(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0430Hl.A02 >= 21 && A0A(codecCapabilities);
    }
    ...
    public static boolean A0B(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0430Hl.A02 >= 21 && A0C(codecCapabilities);
    }
    ...
    public final Point A0E(int i, int i2) {
        ...
        if (videoCapabilities == null) {
            A06(A03(j.AppCompatTheme_viewInflaterClass, 11, 68));
            return null;
        }
        int widthAlignment = videoCapabilities.getWidthAlignment();
        int heightAlignment = videoCapabilities.getHeightAlignment();
        int heightAlignment2 = C0430Hl.A04(i, widthAlignment);
        return new Point(heightAlignment2 * widthAlignment, C0430Hl.A04(i2, heightAlignment) * heightAlignment);
    }
    ...
    public final boolean A0G(int i) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.A00;
        if (codecCapabilities == null) {
            A06(A03(371, 15, j.AppCompatTheme_textAppearanceSearchResultSubtitle));
            return false;
        }
        MediaCodecInfo.AudioCapabilities audioCapabilities = codecCapabilities.getAudioCapabilities();
        if (audioCapabilities == null) {
    ...
    public final boolean A0H(int i, int i2, double d) {
        ...
        if (videoCapabilities == null) {
            ...
            if (i >= i2 || !A0D(videoCapabilities, i2, i, d)) {
                A06(A03(458, 21, j.AppCompatTheme_viewInflaterClass) + i + A03 + i2 + A03 + d);
                return false;
            }
    ...
    public final boolean A0I(String str) {
        ...
        Pair<Integer, Integer> A02 = C0316Cx.A02(str);
        if (A02 == null) {
            return true;
        }
        ...
        if (codecMimeType.charAt(21) != 'h') {
            ...
            A06(A03(335, 20, j.AppCompatTheme_textAppearanceSearchResultTitle) + str + A03 + A05);
            return false;
        }
        throw new RuntimeException();
    }
