...
public final class IB {
    ...
    public final ServiceConnection A02 = new IA(this);
    ...
    public IB(C0806Wj c0806Wj, String str, String str2) {
        this.A03 = c0806Wj;
        this.A05 = str;
        this.A04 = str2;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A07(int i, C01887m c01887m) {
        this.A03.A06().A8u(A05(189, 14, 74), i, c01887m);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A08(int i, C01887m c01887m) {
        c01887m.A03(1);
        this.A03.A06().A8v(A05(189, 14, 74), i, c01887m);
    }

    public final void A0C() {
        A08(C01877l.A1s, new C01887m(A05(j.AppCompatTheme_textAppearanceSearchResultSubtitle, 18, 66), this.A05));
        Intent intent = new Intent();
        intent.setClassName(A05(170, 19, 125), A05(j.AppCompatTheme_windowMinWidthMinor, 51, 26));
        try {
            if (!this.A03.bindService(intent, this.A02, 1)) {
                A08(C01877l.A1o, new C01887m(A05(51, 50, 11)));
                this.A03.unbindService(this.A02);
            }
        } catch (Exception e) {
            A07(C01877l.A1n, new C01887m(e));
        }
    }
}
