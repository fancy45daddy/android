...
public final class Q2 implements Map<String, String> {
    ...
    public final Q2 A04(String str, String str2) {
        this.A00.put(str, str2);
        return this;
    }

    public final Q2 A05(Map<? extends String, ? extends String> arg) {
        putAll(arg);
        return this;
    }
    ...
    public final String A06() {
        ...
        for (String str : this.A00.keySet()) {
            if (sb.length() > 0) {
                ...
                sb.append(A00(0, 1, j.AppCompatTheme_windowActionModeOverlay));
            }
            sb.append(str);
