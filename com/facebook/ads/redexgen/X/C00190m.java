...
import com.facebook.ads.redexgen.X.C00190m;
...
public final class C00190m {
    ...
    public C00190m(IT it, final Activity activity, int i) {
        this.A05 = it;
    ...
    @Nullable
    public static C00190m A00(IT it, @Nullable Activity activity) {
        return A01(it, activity, Build.VERSION.SDK_INT);
    }

    @Nullable
    @VisibleForTesting
    public static C00190m A01(IT it, @Nullable Activity activity, int i) {
        if (activity != null && i >= 14) {
            return new C00190m(it, activity, i);
        }
        return null;
    }

    private void A04(String str, long j, long j2, @Nullable EnumC00120e enumC00120e) {
        HashMap hashMap = new HashMap();
        hashMap.put(A02(9, 10, 8), Long.toString(j));
        hashMap.put(A02(0, 9, 34), Long.toString(j2));
        if (enumC00120e != null) {
            hashMap.put(A02(19, 7, 9), enumC00120e.name());
        }
    ...
    public final void A06(@Nullable EnumC00120e enumC00120e) {
        this.A02 = enumC00120e;
    }
    ...
    public final void A07(String str) {
        ...
        EnumC00120e enumC00120e = EnumC00120e.A03;
        if (A07[2].charAt(6) == '9') {
