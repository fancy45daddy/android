...
public enum EnumC01485o {
    ...
    EnumC01485o(String str) {
        this.A00 = str;
    }

    @Nullable
    public static EnumC01485o A00(@Nullable String str) {
        EnumC01485o[] values;
        for (EnumC01485o enumC01485o : values()) {
            if (enumC01485o.A00.equals(str)) {
                return enumC01485o;
            }
        }
        return null;
