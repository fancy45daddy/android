...
public final class C0687Rq extends AbstractC0560Ms {
    ...
    public final WeakReference<InterfaceC0563Mv> A0A;
    ...
    static {
        A06();
        A0H = C0687Rq.class.getSimpleName();
    }

    public C0687Rq(C0806Wj c0806Wj, WeakReference<InterfaceC0563Mv> weakReference, int i, String str) {
        this(c0806Wj, weakReference, i, false);
        if (ID.A1K(c0806Wj)) {
            c0806Wj.A00().A09().AFE(this, str == null ? A04(0, 0, 74) : str, false, true);
            this.A06 = true;
        }
    }

    public C0687Rq(C0806Wj c0806Wj, WeakReference<InterfaceC0563Mv> weakReference, int i, boolean z) {
        super(c0806Wj);
        ...
        this.A02 = new C0691Ru(this);
        this.A03 = new C0627Pi(this, i, new WeakReference(this.A02), this.A09);
        setWebChromeClient(A0D());
        setWebViewClient(A0E());
        getSettings().setSupportZoom(false);
        getSettings().setCacheMode(1);
        if (Build.VERSION.SDK_INT > 16) {
            addJavascriptInterface(new C0562Mu(this, weakReference.get(), this.A03, this.A0B, this.A0C, this.A09), A04(0, 9, 97));
        }
    }
    ...
    public final WebViewClient A0E() {
        return new C0565Mx(this.A09, this.A0A, new WeakReference(this.A03), new WeakReference(this.A01), new WeakReference(this.A0C), new WeakReference(this), this.A0D, this.A0E, this.A04);
    }
    ...
    public final void A0F() {
        this.A09.A0D().AFG();
        this.A0B.set(true);
        new Handler(Looper.getMainLooper()).post(new C0689Rs(this.A03));
    }

    public final void A0G(int i, int i2) {
        C0627Pi c0627Pi = this.A03;
        if (c0627Pi != null) {
            c0627Pi.A0W(i);
            this.A03.A0X(i2);
        }
