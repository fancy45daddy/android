...
public final class C8A {
    ...
    public static long A01(C7G c7g) {
        try {
            ...
            if (A03.compareAndSet(false, true)) {
                c7g.A06().A8u(A02(144, 7, j.AppCompatTheme_windowFixedWidthMinor), C01877l.A1E, new C01887m(e));
            }
            return -1L;
        }
    }
    ...
    public static String A05(C7G c7g) {
        ...
        A07(c7g, jSONObject, A02(j.AppCompatTheme_textColorSearchUrl, 18, j.AppCompatTheme_windowActionModeOverlay), String.valueOf(K4.A01(c7g)));
        A07(c7g, jSONObject, A02(161, 13, j.AppCompatTheme_windowActionBar), String.valueOf(A09(c7g)));
    ...
    public static boolean A08() {
        ...
        String A022 = A02(144, 7, j.AppCompatTheme_windowFixedWidthMinor);
