...
public final class C6Z extends M1 {
    ...
    public void setImage(@Nullable String str, @Nullable N1 n1) {
        if (str == null) {
            setVisibility(8);
            return;
        }
        setVisibility(0);
        AsyncTaskC0685Ro downloadImageTask = new AsyncTaskC0685Ro(this.A00, this.A01).A04();
        if (n1 != null) {
            downloadImageTask.A06(n1);
        }
