...
public final class HO {
    ...
    */
    ...
    public static int A01(String str) {
        ...
        if (A0B(str)) {
            ...
            A01[2] = "Tbf";
            return 2;
        } else if (A0A(str) || A04(23, 19, 49).equals(str) || A04(42, 19, 78).equals(str) || A04(193, 25, 9).equals(str) || A04(306, 20, 43).equals(str) || A04(j.AppCompatTheme_viewInflaterClass, 20, 74).equals(str) || A04(239, 28, 97).equals(str) || A04(218, 21, 14).equals(str) || A04(267, 19, j.AppCompatTheme_textColorAlertDialogListItem).equals(str) || A04(130, 18, j.AppCompatTheme_textAppearanceSmallPopupMenu).equals(str) || A04(95, 15, 90).equals(str) || A04(61, 19, 98).equals(str)) {
            return 3;
        } else {
            if (A04(80, 15, j.AppCompatTheme_windowMinWidthMinor).equals(str) || A04(175, 18, 63).equals(str) || A04(286, 20, 7).equals(str) || A04(148, 27, 74).equals(str)) {
                return 4;
            }
            return A02(str);
        }
            ...
            if (i != 33) {
                ...
                if (i == 35) {
                    ...
                    if (strArr3[7].charAt(25) != strArr3[1].charAt(25)) {
                        return A04(532, 10, j.AppCompatTheme_textAppearanceSmallPopupMenu);
                    }
                    String[] strArr4 = A01;
                ...
                if (i != 64) {
                    if (i == 163) {
                        ...
                        return A04(576, 10, j.AppCompatTheme_textAppearanceSmallPopupMenu);
                    } else if (i != 177) {
                        if (i != 165) {
                            if (i != 166) {
                                switch (i) {
    ...
    */
    ...
    public static boolean A0B(String str) {
        return A04(518, 5, j.AppCompatTheme_windowActionBarOverlay).equals(A07(str));
    }
}
