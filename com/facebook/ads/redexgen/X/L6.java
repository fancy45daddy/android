...
public final class L6 {
    ...
    private EnumC0499Ki A00() {
        View view;
        View view2 = this.A0G;
        if (view2 == null || (view = this.A0F) == null) {
            return EnumC0499Ki.A0I;
        }
        if (view2 != view) {
            return EnumC0499Ki.A0G;
        }
        if (Build.VERSION.SDK_INT < 4) {
            return EnumC0499Ki.A0F;
        }
        Object tag = this.A0G.getTag(EnumC0499Ki.A02);
        if (tag == null) {
            return EnumC0499Ki.A0H;
        }
        if (!(tag instanceof EnumC0499Ki)) {
            return EnumC0499Ki.A0J;
        }
        return (EnumC0499Ki) tag;
    }
    ...
    public final Map<String, String> A04() {
        ...
        if (j > 0) {
            ...
            if (j2 > j) {
                ...
                String radius = A01(20, 11, j.AppCompatTheme_toolbarNavigationButtonStyle);
                ...
                String radius4 = A01(j.AppCompatTheme_textAppearanceSearchResultTitle, 6, 16);
                ...
                String radius9 = A01(180, 6, j.AppCompatTheme_textAppearanceSmallPopupMenu);
                hashMap.put(radius9, valueOf10);
                String valueOf11 = String.valueOf(this.A07);
                String radius10 = A01(56, 6, j.AppCompatTheme_windowFixedWidthMinor);
                hashMap.put(radius10, valueOf11);
                String valueOf12 = String.valueOf(this.A08);
                String radius11 = A01(62, 6, j.AppCompatTheme_tooltipForegroundColor);
                ...
                String radius16 = A01(136, 7, j.AppCompatTheme_windowFixedWidthMinor);
        ...
        String radius18 = A01(20, 11, j.AppCompatTheme_toolbarNavigationButtonStyle);
        ...
        String radius42 = A01(j.AppCompatTheme_textAppearanceSearchResultTitle, 6, 16);
        ...
        String radius92 = A01(180, 6, j.AppCompatTheme_textAppearanceSmallPopupMenu);
        hashMap2.put(radius92, valueOf102);
        String valueOf112 = String.valueOf(this.A07);
        String radius102 = A01(56, 6, j.AppCompatTheme_windowFixedWidthMinor);
        hashMap2.put(radius102, valueOf112);
        String valueOf122 = String.valueOf(this.A08);
        String radius112 = A01(62, 6, j.AppCompatTheme_tooltipForegroundColor);
        ...
        String radius162 = A01(136, 7, j.AppCompatTheme_windowFixedWidthMinor);
    ...
    public final void A06(C0806Wj c0806Wj, MotionEvent motionEvent, @Nullable View view, View view2) {
        if (view == null) {
            c0806Wj.A0D().AFC();
            return;
        }
