...
public enum EnumC0463Iu {
    A06(-1, 100, 1, 0),
    A07(-1, j.AppCompatTheme_windowNoTitle, 2, 1),
    A08(-1, 300, 3, 2),
    A09(-1, 400, 4, 3),
    A0A(-1, 50, 5, 4),
    A0B(-1, -1, 6, 5);
    ...
    EnumC0463Iu(int i, int i2, int i3, int i4) {
        this.A03 = i;
        this.A01 = i2;
        this.A02 = i3;
        this.A00 = i4;
    ...
    public static EnumC0463Iu A00(int i) {
        EnumC0463Iu[] values;
        for (EnumC0463Iu enumC0463Iu : values()) {
            if (enumC0463Iu.A00 == i) {
                return enumC0463Iu;
            }
        }
        return null;
