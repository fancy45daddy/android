...
public class C00652g<K, V> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C00652g) {
            C00652g c00652g = (C00652g) obj;
            if (size() != c00652g.size()) {
                return false;
            }
            for (int i = 0; i < this.A00; i++) {
                try {
                    K A09 = A09(i);
                    V A0B = A0B(i);
                    Object obj2 = c00652g.get(A09);
                    if (A0B == null) {
                        if (obj2 == null && c00652g.containsKey(A09)) {
                        }
                        return false;
