...
public abstract class YP implements AnonymousClass27 {
    ...
    public final InterfaceC00541v A00;
    ...
    public YP(C0806Wj c0806Wj, AnonymousClass23 anonymousClass23) {
        this.A01 = c0806Wj;
        DynamicLoaderFactory.makeLoader(this.A01).getInitApi().onAdLoadInvoked(this.A01);
        this.A00 = new YS(c0806Wj, this);
    ...
    public final void A06(int i, AdErrorType adErrorType, @Nullable String str) {
        ...
        String A02 = A02(48, 21, j.AppCompatTheme_windowActionModeOverlay);
        if (str != null) {
            bundle.putString(A02, str);
        } else {
            bundle.putString(A02, adErrorType.getDefaultErrorMessage());
        }
        bundle.putInt(A02(17, 18, j.AppCompatTheme_textAppearanceSearchResultSubtitle), adErrorType.getErrorCode());
        ABR(i, this.A02, bundle);
    }

    @Override // com.facebook.ads.redexgen.X.AnonymousClass27
    public final void ABR(int i, String str, @Nullable Bundle bundle) {
