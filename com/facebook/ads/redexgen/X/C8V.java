...
public final class C8V {
    ...
    public final int A04(C8V c8v) {
        int i = this.A00;
        int i2 = c8v.A00;
        if (i != i2) {
            return i - i2;
        }
        return this.A01 - c8v.A01;
    }

    public final C8V A05(int i) {
        int i2 = this.A01;
        if (i + i2 >= 0) {
            return new C8V(this.A00, i2 + i);
        }
