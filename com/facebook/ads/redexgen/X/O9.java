...
public final class O9 {
     ...
     */
    public static O8 A00(C0806Wj c0806Wj, JSONObject jSONObject, C6G c6g, C0444Ib c0444Ib, C0577Nj c0577Nj, boolean z) {
        boolean z2;
        String str;
        String str2;
        boolean z3 = z;
        ...
        c0444Ib.A02(EnumC0443Ia.A0P, null);
        try {
            ...
            JSONArray optJSONArray = jSONObject.optJSONArray(A01(j.AppCompatTheme_windowMinWidthMajor, 15, 1));
            if (optJSONArray != null) {
                for (int i = 0; i < optJSONArray.length(); i++) {
                    String optString3 = optJSONArray.optString(i);
                    arrayList.add(optString3);
                    if (z2) {
                        optJSONArray.put(i, c6g.A0Q(optString3));
                    }
                }
            }
            ...
            if (optJSONArray2 != null) {
                for (int i2 = 0; i2 < optJSONArray2.length(); i2++) {
                    A03(arrayList, arrayList2, optJSONArray2.optJSONObject(i2), c6g, z2);
                }
            } else {
                A03(arrayList, arrayList2, jSONObject, c6g, z2);
            }
        } catch (JSONException unused) {
            c0577Nj.A04(C01877l.A15, A01(0, 43, 79));
        }
        return new O8(jSONObject, str, str2, arrayList, arrayList2, arrayList3, z3);
    }
    ...
    public static void A03(ArrayList<String> videoUrls, ArrayList<String> arrayList, JSONObject jSONObject, C6G c6g, boolean z) throws JSONException {
        JSONObject optJSONObject = jSONObject.optJSONObject(A01(137, 5, j.AppCompatTheme_toolbarNavigationButtonStyle));
