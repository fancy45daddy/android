...
public final class C0390Fx {
     ...
     */
    public static void A0C(String str, String str2, C0387Fu c0387Fu, List<C0385Fs> list) {
        C0388Fv c0388Fv;
        ...
        while (i < str2.length()) {
            ...
            if (charAt == '&') {
                ...
                if (indexOf != -1) {
                    ...
                    if (indexOf == indexOf2) {
                        spannableStringBuilder.append((CharSequence) A03(1, 1, j.AppCompatTheme_viewInflaterClass));
                    }
                    i = indexOf + 1;
                } else {
                        ...
                        if (z) {
                            do {
                                ...
                                if (A02[5].length() != 16) {
                                    ...
                                    c0388Fv = (C0388Fv) arrayDeque.pop();
                                    A0B(str, c0388Fv, spannableStringBuilder, list, arrayList);
                                } else {
                            ...
                            } while (!c0388Fv.A01.equals(A042));
                        } else if (!z2) {
                            arrayDeque.push(C0388Fv.A01(substring, spannableStringBuilder.length()));
                        }
                    }
                }
            }
        ...
        while (!arrayDeque.isEmpty()) {
            A0B(str, (C0388Fv) arrayDeque.pop(), spannableStringBuilder, list, arrayList);
        }
        A0B(str, C0388Fv.A00(), spannableStringBuilder, list, arrayList);
        c0387Fu.A0C(spannableStringBuilder);
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 14 out of bounds for length 13
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public final boolean A0G(HV hv, C0387Fu c0387Fu, List<C0385Fs> list) {
        String A0P = hv.A0P();
        if (A0P == null) {
            return false;
        }
        ...
        if (matcher.matches()) {
            return A0F(null, matcher, hv, c0387Fu, this.A00, list);
        }
        String A0P2 = hv.A0P();
        if (A0P2 == null) {
            return false;
        ...
        if (matcher2.matches()) {
            return A0F(A0P.trim(), matcher2, hv, c0387Fu, this.A00, list);
        }
        return false;
    }
    ...
    public static int A00(String str) {
        ...
        switch (str.hashCode()) {
            ...
            case -1074341483:
                ...
                break;
            case 100571:
                boolean equals = str.equals(A03(203, 3, j.AppCompatTheme_textAppearanceSearchResultTitle));
                if (A02[3].length() != 10) {
    ...
    public static Layout.Alignment A02(String str) {
        ...
        switch (str.hashCode()) {
            ...
            case -1074341483:
                ...
                break;
            case 100571:
                if (str.equals(A03(203, 3, j.AppCompatTheme_textAppearanceSearchResultTitle))) {
                    c = 4;
                    break;
                }
                c = 65535;
            ...
            case 3317767:
                ...
                break;
            case 108511772:
                if (str.equals(A03(272, 5, j.AppCompatTheme_textColorSearchUrl))) {
                    c = 5;
                    break;
                }
                c = 65535;
    ...
    public static String A04(String str) {
        ...
        return C0430Hl.A0m(trim, A03(156, 5, 39))[0];
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0086, code lost:
        if (com.facebook.ads.redexgen.X.C0390Fx.A02[2].charAt(8) == 'y') goto L48;
     */
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0088, code lost:
        com.facebook.ads.redexgen.X.C0390Fx.A02[3] = "V2wLbBmXpgkEOhtSXmoT1";
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x009d, code lost:
        r4 = r6.A0H();
        r2 = com.facebook.ads.redexgen.X.C0390Fx.A02;
     */
    /* JADX WARN: Code restructure failed: missing block: B:26:0x00b1, code lost:
        if (r2[0].length() == r2[6].length()) goto L46;
     */
    /* JADX WARN: Code restructure failed: missing block: B:27:0x00b3, code lost:
        com.facebook.ads.redexgen.X.C0390Fx.A02[3] = "i3U";
     */
    ...
    */
    public static void A06(android.text.SpannableStringBuilder r5, com.facebook.ads.redexgen.X.C0385Fs r6, int r7, int r8) {
        /*
            Method dump skipped, instructions count: 314
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0390Fx.A06(android.text.SpannableStringBuilder, com.facebook.ads.redexgen.X.Fs, int, int):void");
    }
    ...
    public static void A08(String str, C0387Fu c0387Fu) {
    ...
    public static void A09(String str, C0387Fu c0387Fu) throws NumberFormatException {
        int indexOf = str.indexOf(44);
        if (indexOf != -1) {
            c0387Fu.A06(A00(str.substring(indexOf + 1)));
            str = str.substring(0, indexOf);
        } else {
            c0387Fu.A06(Integer.MIN_VALUE);
        }
        if (str.endsWith(A03(2, 1, 77))) {
            c0387Fu.A03(C0391Fy.A00(str)).A07(0);
            return;
        }
        ...
        C0387Fu A032 = c0387Fu.A03(commaIndex);
        String[] strArr = A02;
    ...
    public static void A0A(String str, C0387Fu c0387Fu) throws NumberFormatException {
        int indexOf = str.indexOf(44);
        if (indexOf != -1) {
            int commaIndex = indexOf + 1;
            c0387Fu.A08(A00(str.substring(commaIndex)));
            str = str.substring(0, indexOf);
        } else {
            c0387Fu.A08(Integer.MIN_VALUE);
        }
        c0387Fu.A04(C0391Fy.A00(str));
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static void A0B(java.lang.String r11, com.facebook.ads.redexgen.X.C0388Fv r12, android.text.SpannableStringBuilder r13, java.util.List<com.facebook.ads.redexgen.X.C0385Fs> r14, java.util.List<com.facebook.ads.redexgen.X.C0389Fw> r15) {
        /*
            Method dump skipped, instructions count: 332
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0390Fx.A0B(java.lang.String, com.facebook.ads.redexgen.X.Fv, android.text.SpannableStringBuilder, java.util.List, java.util.List):void");
    }

    public static void A0D(List<C0385Fs> list, String str, C0388Fv c0388Fv, List<C0389Fw> list2) {
        int size = list.size();
        for (int i = 0; i < size; i++) {
            C0385Fs c0385Fs = list.get(i);
            int i2 = c0385Fs.A09(str, c0388Fv.A01, c0388Fv.A03, c0388Fv.A02);
            if (i2 > 0) {
                list2.add(new C0389Fw(i2, c0385Fs));
            }
        }
    ...
    */
    public static boolean A0E(java.lang.String r10) {
        ...
        L64:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.C0390Fx.A02
            r0 = 3
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 10
            if (r1 == r0) goto Lb2
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.C0390Fx.A02
        ...
        Lb2:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0390Fx.A0E(java.lang.String):boolean");
    }

    public static boolean A0F(String str, Matcher matcher, HV hv, C0387Fu c0387Fu, StringBuilder sb, List<C0385Fs> list) {
        try {
            c0387Fu.A0A(C0391Fy.A01(matcher.group(1))).A09(C0391Fy.A01(matcher.group(2)));
            A08(matcher.group(3), c0387Fu);
            sb.setLength(0);
            while (true) {
                String A0P = hv.A0P();
                if (!TextUtils.isEmpty(A0P)) {
                    ...
                    A0C(str, sb.toString(), c0387Fu, list);
                    return true;
                }
            }
        } catch (NumberFormatException unused) {
