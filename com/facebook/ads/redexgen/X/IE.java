...
public final class IE {
    ...
    public static boolean A02(Context context) {
        return ID.A0P(context).A2G(A00(0, 47, j.AppCompatTheme_tooltipForegroundColor), true);
    }

    public static boolean A03(Context context) {
        return ID.A0P(context).A2G(A00(47, 47, j.AppCompatTheme_windowFixedHeightMinor), false);
    }

    public static boolean A04(Context context) {
        return ID.A0P(context).A2G(A00(139, 46, j.AppCompatTheme_windowFixedHeightMajor), false);
    }

    public static boolean A05(Context context) {
        return Build.VERSION.SDK_INT >= 19 && ID.A0P(context).A2G(A00(185, 15, 91), false);
    }

    public static boolean A06(Context context) {
        return ID.A0P(context).A2G(A00(94, 45, 96), false);
    }
}
