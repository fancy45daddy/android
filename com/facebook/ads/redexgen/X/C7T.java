...
public abstract class C7T {
    ...
    public static String A02(String str, C7N[] c7nArr) {
        StringBuilder sb = new StringBuilder(A01(56, 7, j.AppCompatTheme_toolbarNavigationButtonStyle));
        for (int i = 0; i < c7nArr.length - 1; i++) {
            sb.append(c7nArr[i].A01);
            int i2 = A02[2].length();
            if (i2 != 3) {
                throw new RuntimeException();
            }
        ...
        sb.append(c7nArr[c7nArr.length - 1].A01);
