...
public final class SU implements LK {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:74:0x0373, code lost:
        if (r3 >= r25) goto L79;
     */
    /* JADX WARN: Incorrect condition in loop: B:43:0x01db */
    /* JADX WARN: Incorrect condition in loop: B:60:0x0294 */
    /*
    ...
    public final Bitmap A02(Bitmap bitmap, float f) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                int h2 = h;
                int cores = i2;
                arrayList.add(new LO(iArr, w, h2, (int) f, i, cores, 1));
                h = h2;
                int cores2 = i2;
                vertical.add(new LO(iArr, w, h, (int) f, i, cores2, 2));
            }
            try {
