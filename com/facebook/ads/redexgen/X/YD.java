...
public final class YD implements AnonymousClass22 {
    ...
    public YD(C0806Wj c0806Wj, AnonymousClass20 anonymousClass20, InterfaceC00541v interfaceC00541v, YP yp) {
        this.A03 = c0806Wj;
    ...
    public final void A7y(Message message) {
        ...
        String A00 = A00(152, 3, j.AppCompatTheme_toolbarNavigationButtonStyle);
        if (A01 == null) {
            this.A03.A06().A8u(A00, C01877l.A0K, new C01887m(A00(0, 17, 57)));
            return;
        }
        int i = message.what;
        String A002 = A00(95, 9, 61);
        String A003 = A00(j.AppCompatTheme_textColorAlertDialogListItem, 27, 56);
        ...
        if (i != 10) {
            ...
            if (bundle != null) {
                ...
                int i2 = C01877l.A0V;
                A06.A8u(A00, i2, new C01887m(A003, A002 + message));
            }
            this.A02.A0C(null);
            ...
            switch (message.what) {
                ...
                case 1026:
                    if (this.A02.A02() instanceof InterstitialAdExtendedListener) {
                        InterstitialAdExtendedListener A02 = this.A02.A02();
                        if (A05[2].charAt(18) == 'n') {
                            A02.onInterstitialActivityDestroyed();
                            break;
                        } else {
                            String[] strArr = A05;
        ...
        if (bundle2 != null) {
            ...
            int i4 = C01877l.A0V;
            A062.A8u(A00, i4, new C01887m(A003, A002 + message));
        }
        this.A02.A0C(null);
    }
}
