...
public final class TP implements InterfaceC0448If {
    ...
    public TQ A00;
    @Nullable
    public C0897a3<IJ, IO> A01;
    public final C0805Wi A02;
    public final C0891Zx A03 = C0891Zx.A00();
    ...
    public TP(C0805Wi c0805Wi) {
        this.A02 = c0805Wi;
    }

    private void A01() {
        this.A02.A06().A8u(A00(89, 14, 40), 3600, new C01887m(A00(67, 22, 71)));
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0448If
    public final void AAN() {
        C0897a3<IJ, IO> c0897a3 = this.A01;
        if (c0897a3 != null) {
            c0897a3.A02.A00();
        } else {
            A01();
    ...
    public final void AF4(@Nullable View view) {
        if (this.A01 == null) {
            this.A02.A06().A8u(A00(89, 14, 40), 3600, new C01887m(A00(32, 35, 9)));
            return;
        }
        this.A03.A02(view);
    }
    ...
    @Override // com.facebook.ads.redexgen.X.InterfaceC0448If
    public final void AFD(@Nullable View view, String str, boolean z) {
        AFE(view, str, z, false);
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0448If
    public final void AFE(@Nullable View view, String str, boolean z, boolean z2) {
        AFF(view, str, z, z2, false);
    }

    @Override // com.facebook.ads.redexgen.X.InterfaceC0448If
    public final void AFF(@Nullable View view, String str, boolean z, boolean z2, boolean z3) {
        if (view != null) {
            ...
            this.A01 = C0897a3.A00(new IJ(this.A02, view, str, z, z3), new IO(), A06).A05(new TR(new TO())).A06();
            this.A03.A03(view, this.A01);
            return;
        }
        this.A02.A06().A8u(A00(89, 14, 40), 3600, new C01887m(A00(0, 32, 38)));
    }
}
