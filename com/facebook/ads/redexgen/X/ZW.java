...
public final class ZW implements C0K {
    ...
    public ZW(String str, @Nullable String str2) {
    ...
    private HttpURLConnection A02(int i, int i2) throws IOException, ZY {
        String A01;
        ...
        do {
            ...
            sb.append(A01(234, 16, j.AppCompatTheme_textAppearanceSearchResultTitle));
            if (i > 0) {
                A01 = A01(19, 13, 86) + i;
            } else {
                A01 = A01(0, 0, 78);
            ...
            if (i3 > 5) {
                String url2 = A01(293, 20, j.AppCompatTheme_toolbarNavigationButtonStyle) + i3;
                throw new ZY(url2);
            }
        } while (code != 0);
    ...
    private void A03() throws ZY {
        ...
        try {
            try {
                ...
                Log.i(A07, A01(74, 18, j.AppCompatTheme_textColorAlertDialogListItem) + this.A03 + A01(313, 9, 58) + this.A06 + A01(32, 18, 100) + this.A05);
                C0I.A05(inputStream);
            } catch (IOException e) {
    ...
    private final void A05(int i, int i2) throws ZY {
        try {
            this.A02 = A02(i, i2);
            ...
            throw new ZY(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i, e);
        }
    }
    ...
    public final void close() throws ZY {
        ...
        if (httpURLConnection != null) {
            try {
                ...
                throw new ZY(A01(92, 37, 93), e);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.X.C0K
    public final synchronized int length() throws ZY {
    ...
    public final int read(byte[] bArr) throws ZY {
        ...
        String A01 = A01(183, 24, j.AppCompatTheme_textColorAlertDialogListItem);
        if (inputStream != null) {
            try {
                return inputStream.read(bArr, 0, bArr.length);
            } catch (InterruptedIOException e) {
                throw new F5(A01(278, 15, 96) + this.A03 + A01(0, 15, 66), e);
            } catch (IOException e2) {
                throw new ZY(A01 + this.A03, e2);
            }
        }
        throw new ZY(A01 + this.A03 + A01(51, 23, 21));
    }
