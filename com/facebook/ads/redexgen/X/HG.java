...
public final class HG implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new HE(C0430Hl.A0P(A04(0, 67, 11), Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]));
    }
    ...
    public static EGLDisplay A02() {
        ...
        if (eglGetDisplay == null) {
            throw new HE(A04(j.AppCompatTheme_windowNoTitle, 20, 23));
        }
        int[] iArr = new int[2];
        boolean eglInitialized = EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1);
        if (!eglInitialized) {
            throw new HE(A04(140, 20, j.AppCompatTheme_textColorSearchUrl));
        }
    ...
    public static EGLSurface A03(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, int i) {
        ...
        if (!EGL14.eglMakeCurrent(eGLDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eGLContext)) {
            throw new HE(A04(160, 21, j.AppCompatTheme_windowFixedHeightMinor));
        }
