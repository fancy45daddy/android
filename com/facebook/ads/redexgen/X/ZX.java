...
public final class ZX implements C0G {
     ...
     */
    public final synchronized void A07() throws ZV {
        if (A09()) {
            return;
        }
        A06();
        ...
        if (!this.A00.renameTo(file)) {
            throw new ZV(A00(166, 20, 40) + this.A00 + A00(44, 4, 124) + file + A00(14, 16, 28));
        }
        this.A00 = file;
        try {
            this.A01 = new RandomAccessFile(this.A00, A00(256, 1, 67));
        } catch (IOException e) {
            throw new ZV(A00(123, 14, 124) + this.A00 + A00(0, 14, 84), e);
        }
    }

    public ZX(File file, C0B c0b) throws ZV {
        File file2;
        try {
            if (c0b != null) {
                this.A02 = c0b;
                ...
                this.A00 = file2;
                this.A01 = new RandomAccessFile(this.A00, exists ? A00(256, 1, 67) : A00(257, 2, j.AppCompatTheme_windowMinWidthMinor));
                return;
            }
            throw new NullPointerException();
        } catch (IOException e) {
            throw new ZV(A00(186, 17, 126) + file + A00(0, 14, 84), e);
        }
    }
    ...
    public final synchronized int A03() throws ZV {
        try {
        } catch (IOException e) {
            throw new ZV(A00(137, 29, 81) + this.A00, e);
        }
    ...
    public final synchronized void A05() throws ZV {
        try {
            this.A01.setLength(0L);
        } catch (IOException e) {
            throw new ZV(A00(57, 16, 6), e);
        }
    }

    public final synchronized void A06() throws ZV {
        try {
            this.A01.close();
            this.A02.AF1(this.A00);
        } catch (IOException e) {
            throw new ZV(A00(j.AppCompatTheme_textColorAlertDialogListItem, 19, 99) + this.A00, e);
        }
    }

    public final synchronized void A08(byte[] bArr, int i) throws ZV {
        try {
            if (!A09()) {
                this.A01.seek(A03());
                this.A01.write(bArr, 0, i);
            } else {
                throw new ZV(A00(73, 31, 52) + this.A00 + A00(30, 14, j.AppCompatTheme_windowMinWidthMajor));
            }
        } catch (IOException e) {
            throw new ZV(String.format(Locale.US, A00(203, 53, j.AppCompatTheme_textColorSearchUrl), Integer.valueOf(i), this.A01, Integer.valueOf(bArr.length)), e);
        }
    }
