...
public enum EnumC0465Iw {
    ...
    public static VideoAutoplayBehavior A00(EnumC0465Iw enumC0465Iw) {
        if (enumC0465Iw == null) {
            return VideoAutoplayBehavior.DEFAULT;
        }
        int i = C0464Iv.A00[enumC0465Iw.ordinal()];
        if (i != 1) {
            if (A01[1].charAt(9) != 'M') {
                A01[5] = "KWBYg9gUO";
                if (i != 2) {
    ...
    public static EnumC0465Iw[] valuesCustom() {
        EnumC0465Iw[] valuesCustom = values();
        if (A01[1].charAt(9) != 'M') {
            String[] strArr = A01;
            strArr[6] = "qrA";
            strArr[3] = "mB";
            return (EnumC0465Iw[]) valuesCustom.clone();
        }
        throw new RuntimeException();
    }
}
