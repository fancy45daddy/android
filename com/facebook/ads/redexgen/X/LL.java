...
public final class LL {
    @TargetApi(18)
    public static Bitmap A00(C0806Wj c0806Wj, Bitmap bitmap, int i) throws RSRuntimeException {
        RenderScript renderScript = null;
        Allocation allocation = null;
        Allocation output = null;
        ScriptIntrinsicBlur scriptIntrinsicBlur = null;
        try {
            renderScript = RenderScript.create(c0806Wj);
    ...
    @Nullable
    public static Bitmap A01(C0806Wj c0806Wj, Bitmap bitmap, int i, int i2) {
        ...
        try {
            Bitmap A00 = A00(c0806Wj, createBitmap, i);
            if (i2 != 1) {
            ...
            return new SU().A02(createBitmap, i);
        }
    }
}
