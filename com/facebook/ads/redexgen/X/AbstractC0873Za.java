...
public abstract class AbstractC0873Za implements C0B {
        ...
        for (File file : list) {
            ...
            if (!A08(file, A022, size)) {
                ...
                if (file.delete()) {
                    size--;
                    A022 -= length;
                    Log.i(A03, A03(61, 11, 10) + file + A03(19, 42, j.AppCompatTheme_windowNoTitle));
                } else {
    ...
    static {
        A04();
        A03 = AbstractC0873Za.class.getSimpleName();
    }
    ...
    public void AF1(final File file) throws IOException {
        this.A00.submit(new Callable<Void>(file) { // from class: com.facebook.ads.redexgen.X.0F
            ...
            public final Void call() throws Exception {
                AbstractC0873Za.this.A06(this.A00);
                return null;
            }
        });
    }
