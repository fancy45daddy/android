...
public class AnonymousClass37 {
    ...
    public int A05(View view) {
        if (!A04) {
            try {
                A02 = View.class.getDeclaredField(A01(22, 10, j.AppCompatTheme_windowFixedWidthMajor));
    ...
    public void A0B(View view) {
        if (view instanceof InterfaceC00732p) {
            ((InterfaceC00732p) view).stopNestedScroll();
        }
    }
    ...
    public final void A0E(View view, @Nullable C00702m c00702m) {
        view.setAccessibilityDelegate(c00702m == null ? null : c00702m.A00());
    }

    public void A0F(View view, InterfaceC00762s interfaceC00762s) {
    }
