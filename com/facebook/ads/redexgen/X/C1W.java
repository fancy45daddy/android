...
public final class C1W implements Serializable {
    ...
    public static String A03(int i, int i2, int i3) {
        ...
        for (int i4 = 0; i4 < copyOfRange.length; i4++) {
            ...
            copyOfRange[i4] = (byte) (i5 ^ j.AppCompatTheme_windowMinWidthMajor);
        }
    ...
    public C1W(String str, String str2, int i, String str3, String str4, N3 n3, int i2, boolean z, boolean z2, C1X c1x, boolean z3, String str5) {
        if (z3) {
            this.A08 = UUID.randomUUID().toString();
            Uri uri = KM.A00(str).buildUpon().appendQueryParameter(A03(132, 11, j.AppCompatTheme_windowActionBar), this.A08).appendQueryParameter(A03(58, 12, 69), str5).build();
    ...
    public static int A00(JSONObject jSONObject) {
        ...
        return jSONObject.optInt(A03(263, 19, j.AppCompatTheme_textAppearanceSearchResultTitle), 0);
    }
    ...
    public static C1W A01(JSONObject jSONObject) {
        ...
        C1X precachingMethod = C1X.A00(optJSONObject.optString(A03(211, 17, 50), A0F.name()));
        return new C1W(optJSONObject.optString(A03(282, 3, 72)), optJSONObject.optString(A03(143, 19, 61)), A00(jSONObject), A05(optJSONObject), A04(optJSONObject), A02(optJSONObject), optJSONObject.optInt(A03(285, 32, 0), 5000), optJSONObject.optBoolean(A03(j.AppCompatTheme_textAppearanceSmallPopupMenu, 17, 87), true), optJSONObject.optBoolean(A03(88, 15, 37)), precachingMethod, optJSONObject.optBoolean(A03(162, 25, j.AppCompatTheme_windowActionBar)), jSONObject.optString(A03(70, 2, 71)));
    }

    public static N3 A02(JSONObject jSONObject) {
        int orientation = jSONObject.optInt(A03(187, 11, 74), A0G.A03());
        return N3.A00(orientation);
    }

    public static String A04(JSONObject jSONObject) {
        JSONObject optJSONObject = jSONObject.optJSONObject(A03(j.AppCompatTheme_windowNoTitle, 12, 5));
    ...
    public static String A05(JSONObject jSONObject) {
        JSONObject optJSONObject = jSONObject.optJSONObject(A03(j.AppCompatTheme_windowNoTitle, 12, 5));
        String A03 = A03(45, 13, j.AppCompatTheme_textAppearanceSearchResultSubtitle);
