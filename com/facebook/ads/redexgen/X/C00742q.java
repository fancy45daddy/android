...
public final class C00742q {
    ...
    public C00742q(@NonNull View view) {
        this.A04 = view;
    }
    ...
    public final boolean A07(float f, float f2) {
        ...
        return C3O.A06(A00, this.A04, f, f2);
    }
    ...
    public final boolean A08(float f, float f2, boolean z) {
        ...
        return C3O.A07(A00, this.A04, f, f2, z);
    }
    ...
    public final boolean A0D(int i, int i2, int i3, int i4, @Nullable int[] iArr, int startX) {
        ...
        if (i != 0 || i2 != 0 || i3 != 0 || i4 != 0) {
            ...
            C3O.A03(A00, this.A04, i, i2, i3, i4, startX);
            if (iArr != null) {
                this.A04.getLocationInWindow(iArr);
                iArr[0] = iArr[0] - i5;
                iArr[1] = iArr[1] - i6;
    ...
    */
    public final boolean A0F(int r17, int r18, @androidx.annotation.Nullable int[] r19, @androidx.annotation.Nullable int[] r20, int r21) {
        ...
        L20:
            r7 = 0
            r6 = 0
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.C00742q.A05
            r0 = 3
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 9
            if (r1 == r0) goto L9b
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.C00742q.A05
        ...
        La7:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C00742q.A0F(int, int, int[], int[], int):boolean");
    }
}
