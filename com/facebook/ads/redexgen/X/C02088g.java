...
public final class C02088g {
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 23 out of bounds for length 23
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:39)
     */
    public final synchronized C8X A06(int i, byte[] bArr, int i2, int[] iArr, int i3) throws IOException {
        C02078f A00 = A00();
        boolean z = false;
        int i4 = 1;
        if (i >= 0) {
            ...
            if (i5 <= i) {
                return new C8X(z ? C8W.A03 : C8W.A04, i, i, 0);
            }
            A00.A02.seek(j);
            A00.A02.read(bArr, i2, i6);
            return new C8X(C8W.A02, i, i5, i6);
        }
        throw new IOException(String.format(Locale.US, A01(57, 29, j.AppCompatTheme_windowFixedHeightMajor), Integer.valueOf(i)));
    }
    ...
    public C02088g(File file) throws IOException {
        this.A02 = file;
        if (!file.exists()) {
            this.A00 = C02078f.A03(file);
        } else if (!file.isFile()) {
            throw new IOException(String.format(Locale.US, A01(25, 32, 30), file.getCanonicalPath()));
        }
    }

    private C02078f A00() throws IOException {
        if (!this.A01) {
            if (this.A00 == null) {
                this.A00 = C02078f.A04(this.A02);
            }
            return this.A00;
        }
    ...
    private void A03(int i, long j) throws IOException {
        this.A00.A03[i] = j;
        this.A00.A02.seek(C02078f.A02(i));
    ...
    public final synchronized void A08() throws IOException {
        if (!this.A01) {
            A07();
            if (!this.A02.delete()) {
                throw new IOException(String.format(Locale.US, A01(0, 25, j.AppCompatTheme_windowNoTitle), this.A02.getCanonicalPath()));
            }
        } else {
            throw new IOException(A01(86, 28, 15));
        }
