...
public enum EnumC0499Ki {
    ...
    EnumC0499Ki(int i, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i;
        this.A01 = nativeComponentTag;
    }

    public static EnumC0499Ki A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC0499Ki[] values;
        for (EnumC0499Ki enumC0499Ki : values()) {
            if (enumC0499Ki.A01 == nativeComponentTag) {
                return enumC0499Ki;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC0499Ki internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, EnumC0499Ki enumC0499Ki) {
        if (view != null && enumC0499Ki != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, enumC0499Ki);
        }
    }
