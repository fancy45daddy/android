...
public final class JT {
    ...
    public JT(C7G c7g, String str, @Nullable C0507Kq c0507Kq, J8 j8, @Nullable String str2, int i, boolean z, boolean z2, JD jd, @Nullable String str3, @Nullable String str4, @Nullable String str5) {
        this.A01 = c7g;
        this.A06 = str;
        this.A03 = c0507Kq;
        this.A02 = j8;
    ...
    private long A00() {
        SharedPreferences A00 = C0473Jf.A00(this.A01);
    ...
    public final Map<String, String> A08(Map<String, String> map) {
        ...
        A03(hashMap, A01(125, 4, 91), C01525s.A00().A03());
        if (C01525s.A00().A04()) {
            A01 = A01(0, 1, 52);
        } else {
            A01 = A01(1, 1, 52);
        ...
        C0507Kq c0507Kq = this.A03;
        if (c0507Kq != null) {
            A03(hashMap, A01(276, 5, 52), String.valueOf(c0507Kq.A01()));
            A03(hashMap, A01(j.AppCompatTheme_windowMinWidthMinor, 6, 81), String.valueOf(this.A03.A00()));
        }
        J8 j8 = this.A02;
        if (j8 != null) {
            A03(hashMap, A01(256, 11, 36), String.valueOf(j8.A03()));
        }
        boolean z = this.A0A;
        String[] strArr = A0F;
        ...
        if (idfaFlag.charAt(22) == strArr[3].charAt(22)) {
            ...
            int i = this.A00;
            if (i != 0) {
                A03(hashMap, A01(190, 17, j.AppCompatTheme_windowActionModeOverlay), String.valueOf(i));
            }
            boolean z2 = this.A09;
            if (z2) {
            ...
            if (this.A0C.A06() && this.A0C.A04() != null) {
                A03(hashMap, A01(56, 6, j.AppCompatTheme_windowActionModeOverlay), this.A0C.A04());
            }
            ...
            if (str2 != null) {
                A03(hashMap, A01(245, 11, j.AppCompatTheme_windowFixedHeightMajor), str2);
            }
            A03(hashMap, A01(76, 17, 73), UUID.randomUUID().toString());
            A03(hashMap, A01(20, 36, 122), L5.A06(A00()));
            String str3 = this.A05;
            if (str3 != null) {
                A03(hashMap, A01(j.AppCompatTheme_tooltipForegroundColor, 11, j.AppCompatTheme_windowActionBar), str3);
            }
