    ...
    public final void A05(BroadcastReceiver broadcastReceiver) {
        synchronized (this.A04) {
            ...
            for (int size = remove.size() - 1; size >= 0; size--) {
                ...
                c2s.A01 = true;
                for (int j = 0; j < c2s.A03.countActions(); j++) {
                    String action = c2s.A03.getAction(j);
                    ArrayList<C2S> arrayList = this.A03.get(action);
                    if (arrayList != null) {
                        int i = arrayList.size();
                        for (int i2 = i - 1; i2 >= 0; i2--) {
                            C2S c2s2 = arrayList.get(i2);
            ...
            if (arrayList != null) {
                ...
                while (i < arrayList.size()) {
                    ...
                    if (z) {
                        ...
                        String type6 = A01(j.AppCompatTheme_textColorAlertDialogListItem, 24, 48);
                        sb3.append(type6);
                        sb3.append(c2s.A03);
                        sb3.toString();
                    }
                    if (!c2s.A00) {
                        ...
                        int match = c2s.A03.match(action, type7, scheme2, data, categories, A01(83, 21, 127));
                        if (match >= 0) {
                            if (z) {
                ...
                if (arrayList2 != null) {
                    for (int i2 = 0; i2 < arrayList2.size(); i2++) {
                        ((C2S) arrayList2.get(i2)).A00 = false;
                    }
