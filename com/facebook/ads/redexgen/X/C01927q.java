...
public final class C01927q {
    ...
    public static JSONObject A01(C7G c7g, long j, long j2, long j3, long j4, int i, @Nullable Exception exc) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (exc != null) {
                                    jSONObject.put(A00(29, 5, j.AppCompatTheme_windowFixedHeightMinor), exc.getMessage());
                                }
    ...
    public static void A03(C7G c7g, long j, long j2, long j3, long j4, int i, @Nullable Exception exc) {
        C01887m c01887m = new C01887m(A00(0, 21, 65));
        c01887m.A03(1);
        c01887m.A05(A01(c7g, j, j2, j3, j4, i, exc));
        c7g.A06().A9K(A00(50, 7, 100), C01877l.A1z, c01887m);
    }
}
