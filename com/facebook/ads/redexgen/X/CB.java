...
public final class CB {
    ...
    public CB(boolean z, @Nullable String str, int i, byte[] bArr, int i2, int i3, @Nullable byte[] bArr2) {
        H6.A03((bArr2 == null) ^ (i == 0));
        this.A03 = z;
        this.A02 = str;
        this.A00 = i;
        this.A04 = bArr2;
        this.A01 = new BZ(A00(str), bArr, i2, i3);
    }
    ...
    public static int A00(@Nullable String str) {
        ...
        switch (str.hashCode()) {
            case 3046605:
                if (str.equals(A01(86, 4, j.AppCompatTheme_windowMinWidthMajor))) {
                    c = 2;
                    break;
                }
                break;
