...
public class C0734Tm implements HX<String> {
    ...
    public final boolean A5F(String str) {
        ...
        if (!TextUtils.isEmpty(A0M)) {
            ...
            if ((!A0M.contains(A00(4, 4, j.AppCompatTheme_windowActionModeOverlay)) || A0M.contains(A00(8, 8, 39))) && !A0M.contains(A00(0, 4, 60)) && !A0M.contains(A00(16, 3, 8))) {
                return true;
            }
        }
        return false;
