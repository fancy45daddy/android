...
public class C3M extends ViewGroup {
        ...
        if (this.A01 == null) {
            ...
            if (A0v[2].length() != 14) {
                ...
                if (c3e3 != null) {
                    ...
                    int clientWidth = getClientWidth();
                    float paddingLeft = clientWidth <= 0 ? 0.0f : (getPaddingLeft() / clientWidth) + (2.0f - c3e3.A01);
                    for (int i7 = this.A00 - 1; i7 >= 0; i7--) {
                        if (f2 < paddingLeft || i7 >= max) {
                            if (c3e == null || i7 != c3e.A02) {
                                f2 += A05(i7, i6 + 1).A01;
                                i4++;
                    ...
                    int i8 = i4 + 1;
                    if (f3 < 2.0f) {
                        C3E c3e6 = i8 < this.A0t.size() ? this.A0t.get(i8) : null;
                        if (clientWidth <= 0) {
                            f = 0.0f;
                        } else {
                        ...
                        for (int i9 = this.A00 + 1; i9 < A05; i9++) {
                            if (f3 < f || i9 <= min) {
                                if (c3e6 == null || i9 != c3e6.A02) {
                                    C3E A052 = A05(i9, i8);
                                    i8++;
                                    f3 += A052.A01;
                                    c3e6 = i8 < this.A0t.size() ? this.A0t.get(i8) : null;
                                } else {
                                    f3 += c3e6.A01;
                                    i8++;
                                    c3e6 = i8 < this.A0t.size() ? this.A0t.get(i8) : null;
                                ...
                                break;
                            } else if (i9 == c3e6.A02 && !c3e6.A04) {
                                this.A0t.remove(i8);
                                this.A01.A0B(this, i9, c3e6.A03);
                                c3e6 = i8 < this.A0t.size() ? this.A0t.get(i8) : null;
                            }
                        }
                    }
        ...
        while (true) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (c3f2 != null && c3f2.A05) {
                    int i7 = c3f2.A04 & 7;
                    int i8 = c3f2.A04 & j.AppCompatTheme_windowActionBarOverlay;
                    ...
                    if (c3f2.width != -2) {
                        i9 = 1073741824;
                        i3 = c3f2.width != -1 ? c3f2.width : paddingLeft;
                    } else {
                        i3 = paddingLeft;
                    }
                    if (c3f2.height != -2) {
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        AbstractC00772t abstractC00772t;
        if (this.A0h) {
            return true;
        }
        if ((motionEvent.getAction() == 0 && motionEvent.getEdgeFlags() != 0) || (abstractC00772t = this.A01) == null || abstractC00772t.A05() == 0) {
            return false;
        }
        if (this.A0U == null) {
    ...
    */
    ...
    private final void A0D() {
        ...
        AnonymousClass38.A0B(this, new C0843Xv(this));
        if (AnonymousClass38.A00(this) == 0) {
            AnonymousClass38.A09(this, 1);
        }
        AnonymousClass38.A0C(this, new C0844Xw(this));
    }
    ...
    */
    ...
    private final boolean A0W() {
        AbstractC00772t abstractC00772t = this.A01;
        if (abstractC00772t != null && this.A00 < abstractC00772t.A05() - 1) {
            A0L(this.A00 + 1, true);
            return true;
    ...
    */
    ...
    public AbstractC00772t getAdapter() {
        return this.A01;
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.A0M > 0 && this.A0S != null && this.A0t.size() > 0 && this.A01 != null) {
            ...
            loop0: for (int i2 = c3e.A02; i2 < i; i2++) {
                while (i2 > c3e.A02 && itemCount < size) {
                    itemCount++;
                ...
                if (i2 == c3e.A02) {
                    ...
                    marginOffset = marginOffset2 + c3e.A01 + f2;
                } else {
    ...
    */
    ...
    public final Parcelable onSaveInstanceState() {
        ...
        ss.A00 = this.A00;
        AbstractC00772t abstractC00772t = this.A01;
        if (abstractC00772t != null) {
            Parcelable superState2 = abstractC00772t.A07();
            ss.A01 = superState2;
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void setAdapter(com.facebook.ads.redexgen.X.AbstractC00772t r7) {
        /*
            r6 = this;
