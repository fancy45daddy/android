...
public class C0834Xl implements C4R {
    ...
    public final void A04(C0339Dw c0339Dw, boolean z) {
        this.A00 = 0;
        int[] iArr = this.A03;
        if (iArr != null) {
            Arrays.fill(iArr, -1);
        ...
        C4T c4t = c0339Dw.A06;
        if (c0339Dw.A04 != null && c4t != null && c4t.A1Y()) {
            if (z) {
                boolean A0J = c0339Dw.A00.A0J();
                String[] strArr = A05;
                if (strArr[0].charAt(30) != strArr[5].charAt(30)) {
                    A05[7] = "b5aEeD0";
                    if (!A0J) {
                        c4t.A1v(c0339Dw.A04.A0D(), this);
                    }
                }
                throw new RuntimeException();
            } else if (!c0339Dw.A1t()) {
                c4t.A1u(this.A01, this.A02, c0339Dw.A0s, this);
            }
            int i = this.A00;
            int i2 = c4t.A00;
            String[] strArr2 = A05;
