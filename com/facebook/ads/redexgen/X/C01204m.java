...
public final class C01204m {
    ...
    public static int A00(C01164i c01164i, C4D c4d, View view, View view2, C4T c4t, boolean z) {
        if (c4t.A0W() == 0 || c01164i.A03() == 0 || view == null || view2 == null) {
            return 0;
        }
        if (!z) {
    ...
    public static int A01(C01164i c01164i, C4D c4d, View view, View view2, C4T c4t, boolean z) {
        if (c4t.A0W() == 0 || c01164i.A03() == 0 || view == null || view2 == null) {
            return 0;
        }
        if (!z) {
        ...
        int laidOutArea2 = c01164i.A03();
        return (int) (abs * laidOutArea2);
    }

    public static int A02(C01164i c01164i, C4D c4d, View view, View view2, C4T c4t, boolean z, boolean z2) {
        int laidOutArea;
        if (c4t.A0W() != 0) {
            int A03 = c01164i.A03();
            String[] strArr = A00;
