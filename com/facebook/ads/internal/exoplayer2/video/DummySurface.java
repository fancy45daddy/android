...
import com.facebook.ads.redexgen.X.HandlerThreadC0435Hr;
...
public final class DummySurface extends Surface {
    ...
    public final HandlerThreadC0435Hr A02;
    ...
    public static synchronized boolean A05(Context context) {
        ...
        synchronized (DummySurface.class) {
            z = true;
            if (!A04) {
                A03 = C0430Hl.A02 < 24 ? 0 : A00(context);
                A04 = true;
            }
            if (A03 == 0) {
                z = false;
    ...
    public DummySurface(HandlerThreadC0435Hr handlerThreadC0435Hr, SurfaceTexture surfaceTexture, boolean z) {
        super(surfaceTexture);
        this.A02 = handlerThreadC0435Hr;
        this.A01 = z;
    }

    /* JADX WARN: Code restructure failed: missing block: B:7:0x0027, code lost:
        if (A02(85, 6, a.a.j.AppCompatTheme_windowActionModeOverlay).equals(com.facebook.ads.redexgen.X.C0430Hl.A06) != false) goto L7;
     */
    ...
    */
    ...
    public static DummySurface A01(Context context, boolean z) {
        A03();
        H6.A04(!z || A05(context));
        return new HandlerThreadC0435Hr().A04(z ? A03 : 0);
    }
